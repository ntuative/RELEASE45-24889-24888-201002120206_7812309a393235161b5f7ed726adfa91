package deng.fzip
{
   ...
   public class FZipFile
   {
      ...
      public static const const_1423:int = 10;
      
      public static const const_1344:int = 6;
      
      private static var var_898:Boolean = describeType(ByteArray).factory.method.(@name == "uncompress").hasComplexContent();
      ...
      private var var_152:uint = 0;
      
      private var var_897:uint = 0;
      
      private var var_604:Date;
      ...
      private var var_1344:String = "2.0";
      ...
      private function parseFileContent(param1:IDataInput) : Boolean
      {
         ...
         {
            if(param1.bytesAvailable < var_152)
            {
               return false;
            }
            parseContent(param1);
      ...
      {
         var _loc2_:* = 0;
         if(var_602 === const_629 && !var_1343)
         {
            if(var_898)
            {
               param1.readBytes(var_17,0,var_152);
            }
            else
            {
               if(!var_422)
               ...
               _loc2_ = uint(~var_1579 << 6 & 192);
               _loc2_ += 31 - (30720 | _loc2_) % 31;
               var_17.writeByte(_loc2_);
               param1.readBytes(var_17,2,var_152);
               var_17.position = var_17.length;
               var_17.writeUnsignedInt(var_719);
            }
            var_153 = true;
         }
         else
         {
            if(var_602 != const_1117)
            {
      ...
      public function setContentAsString(param1:String, param2:String = "utf-8") : void
      {
         ...
         if(param1 != null && param1.length > 0)
         {
            ...
            var_603 = ChecksumUtil.CRC32(var_17);
            var_422 = false;
         }
         compress();
      }
      ...
      {
         var_604 = param1 != null ? param1 : new Date();
      }
      ...
      public function serialize(param1:IDataOutput, param2:Boolean, param3:Boolean = false, param4:uint = 0) : uint
      {
         ...
         if(param3)
         {
            ...
            param1.writeShort(var_1073 << 8 | 20);
         }
         else
         {
         ...
         var _loc5_:Date = var_604 != null ? var_604 : new Date();
         var _loc6_:uint = uint(_loc5_.getSeconds()) | uint(_loc5_.getMinutes()) << 5 | uint(_loc5_.getHours()) << 11;
         var _loc7_:uint = uint(_loc5_.getDate()) | uint(_loc5_.getMonth() + 1) << 5 | uint(_loc5_.getFullYear() - 1980) << 9;
         param1.writeShort(_loc6_);
         param1.writeShort(_loc7_);
         param1.writeUnsignedInt(var_603);
         param1.writeUnsignedInt(var_152);
         param1.writeUnsignedInt(var_507);
         var _loc8_:ByteArray = new ByteArray();
         _loc8_.endian = Endian.LITTLE_ENDIAN;
         if(var_306 == "utf-8")
         {
            _loc8_.writeUTFBytes(var_355);
         }
         else
         {
            _loc8_.writeMultiByte(var_355,var_306);
         }
         ...
         if(param2)
         {
            if(!var_422)
            {
               ...
               var_719 = ChecksumUtil.Adler32(var_17,0,var_17.length);
               var_422 = true;
               if(_loc16_)
               {
                  compress();
            ...
            _loc8_.writeShort(4);
            _loc8_.writeUnsignedInt(var_719);
         }
         ...
         if(param3 && false)
         {
            if(var_306 == "utf-8")
            {
               _loc8_.writeUTFBytes(var_1578);
            }
            else
            {
               _loc8_.writeMultiByte(var_1578,var_306);
            }
         }
      ...
      {
         if(param1.bytesAvailable >= var_897 + var_1072)
         {
            parseHeadExt(param1);
            parseFunc = parseFileContent;
            return true;
      ...
      protected function parseHeadExt(param1:IDataInput) : void
      {
         ...
         if(var_306 == "utf-8")
         {
            var_355 = param1.readUTFBytes(var_897);
         }
         else
         {
            var_355 = param1.readMultiByte(var_897,var_306);
         }
         var _loc2_:uint = var_1072;
         while(_loc2_ > 4)
         {
            ...
            if(_loc4_ > _loc2_)
            {
               throw new Error("Parse error in file " + var_355 + ": Extra field data size too big.");
            }
            if(_loc3_ === 56026 && _loc4_ === 4)
            {
               var_719 = param1.readUnsignedInt();
               var_422 = true;
            }
            else if(_loc4_ > 0)
            {
      ...
      protected function parseHead(param1:IDataInput) : void
      {
         ...
         var_1073 = _loc2_ >> 8;
         var_1344 = Math.floor((_loc2_ & 255) / 10) + "." + (_loc2_ & 255) % 10;
         ...
         if(var_602 === const_1344)
         {
            var_2259 = (_loc3_ & 2) !== 0 ? 8192 : 4096;
            var_2258 = (_loc3_ & 4) !== 0 ? 3 : 2;
         }
         else if(var_602 === const_629)
         {
            var_1579 = (_loc3_ & 6) >> 1;
         }
         ...
         var_604 = new Date(_loc11_,_loc10_ - 1,_loc9_,_loc8_,_loc7_,_loc6_,0);
         var_603 = param1.readUnsignedInt();
         var_152 = param1.readUnsignedInt();
      ...
      {
         return "[FZipFile]\n  name:" + var_355 + "\n  date:" + var_604 + "\n  sizeCompressed:" + var_152 + "\n  sizeUncompressed:" + var_507 + "\n  versionHost:" + var_1073 + "\n  versionNumber:" + var_1344 + "\n  compressionMethod:" + var_602 + "\n  encrypted:" + var_1343 + "\n  hasDataDescriptor:" + var_1342 + "\n  hasCompressedPatchedData:" + var_1580 + "\n  filenameEncoding:" + var_306 + "\n  crc32:" + var_603.toString(16) + "\n  adler32:" + var_719.toString(16);
      }
