package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      private var var_88:URLStream;
      
      private var var_482:FZipFile;
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_482 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      {
         var_88.removeEventListener(Event.COMPLETE,defaultHandler);
         var_88.removeEventListener(Event.OPEN,defaultHandler);
         var_88.removeEventListener(HTTPStatusEvent.HTTP_STATUS,defaultHandler);
         var_88.removeEventListener(IOErrorEvent.IO_ERROR,defaultErrorHandler);
         var_88.removeEventListener(SecurityErrorEvent.SECURITY_ERROR,defaultErrorHandler);
         var_88.removeEventListener(ProgressEvent.PROGRESS,progressHandler);
      }
      ...
      {
         var_88.addEventListener(Event.COMPLETE,defaultHandler);
         var_88.addEventListener(Event.OPEN,defaultHandler);
         var_88.addEventListener(HTTPStatusEvent.HTTP_STATUS,defaultHandler);
         var_88.addEventListener(IOErrorEvent.IO_ERROR,defaultErrorHandler);
         var_88.addEventListener(SecurityErrorEvent.SECURITY_ERROR,defaultErrorHandler);
         var_88.addEventListener(ProgressEvent.PROGRESS,progressHandler);
      }
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_704))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_704,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_88 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_704,"EOF"));
            }
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         if(!var_88 && parseFunc == parseIdle)
         {
            var_88 = new URLStream();
            var_88.endian = Endian.LITTLE_ENDIAN;
            addEventHandlers();
            var_40 = [];
            var_129 = new Dictionary();
            parseFunc = parseSignature;
      ...
      {
         if(var_482.parse(param1))
         {
            var_40.push(var_482);
            if(false)
            {
               var_129["null"] = var_482;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1302,var_482));
            var_482 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_40 != null && var_129 != null && param1 < var_40.length)
         {
