package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_1106:String = const_330;
      ...
      public static const const_690:String = "RCL_LOADER_READY";
      ...
      public function RoomContentLoader()
      {
         var_499 = [];
         _wallItems = [];
         var_2224 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2227 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_408 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_267,_loc4_);
      ...
      {
         if(var_169 != null && var_169.hasWorldType(const_261 + param1))
         {
            return var_169.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_408 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_408.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_408.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = var_408.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_330,const_479,ROOM_CONTENT,const_762,const_761];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_15 || _loc2_ == RoomObjectCategoryEnum.const_12)
         {
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2224.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_154 && _loc5_ != RoomObjectLogicEnum.const_106)
         {
            _loc6_ = "@shadow";
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1329);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2227.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1318.add(_loc5_,_loc8_);
               var_169 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_267,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_354,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(var_499.indexOf(param1) >= 0)
         {
            return RoomObjectCategoryEnum.const_15;
         }
         if(_wallItems.indexOf(param1) >= 0)
         {
      ...
      private function continueInitilization() : void
      {
         if(var_2226)
         {
            ...
            if(var_1047 != null)
            {
               var_1047.dispatchEvent(new Event(const_690));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_169 != null)
         {
            return var_169.getWorldHeightScale(const_261 + param1);
         }
         return 1;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               if(_loc3_ == RoomObjectCategoryEnum.const_15 || _loc3_ == RoomObjectCategoryEnum.const_12)
               {
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_26,furniDataLoadedHandler);
            var_1047 = param1;
            var_2228 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2225 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2229 = param2.getKey("public.room.dynamic.download.url","");
            var_2223 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_31 = const_760;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_154 && _loc5_ != RoomObjectVisualizationEnum.const_106)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_367.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_261 + param1) == RoomObjectCategoryEnum.const_40)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1318.getValue(param1) != null)
         {
            var_169 = var_1318.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_390,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_169 != null)
         {
            return var_169.getWorldScale(const_261 + param1);
         }
         return 32;
      }
