package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_559);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_893);
         ...
         if(_loc7_ != null)
         {
            switch(param1.type)
            {
               ...
               case RoomObjectWidgetRequestEvent.const_108:
                  ...
                  break;
               case RoomObjectWidgetRequestEvent.const_73:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_73,param2,param3,_loc4_,_loc6_));
            }
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.const_398:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1196));
               break;
            case RoomObjectFurnitureActionEvent.const_436:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_925));
         }
      }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_15 || _loc5_ == RoomObjectCategoryEnum.const_19)
               {
                  _loc7_ = _loc11_.x;
                  _loc8_ = _loc11_.y;
               }
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_19 && _loc3_.typeId == RoomObjectTypeEnum.const_266)
               {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_12:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_482,param1,param2,param3,param4));
         }
      }
      ...
      private function handleObjectPlace(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ == null)
         {
            if(_loc5_.category == RoomObjectCategoryEnum.const_15 && _loc8_ != null)
            {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.const_15)
            {
               if(_loc6_ != null)
               {
      ...
      private function changeObjectState(param1:int, param2:int, param3:int, param4:String, param5:int, param6:Boolean) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if(_loc7_ == RoomObjectCategoryEnum.const_15)
            {
               if(!param6)
               {
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         var _loc10_:String = getMouseEventId(RoomObjectCategoryEnum.const_183,MouseEvent.CLICK);
         switch(_loc4_)
         {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_40)
         {
            ...
            if(_loc12_ != _loc10_)
            {
               ...
               if(_loc13_ != null)
               {
                  _loc13_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_343,param2,param3,-1,RoomObjectCategoryEnum.const_183));
               }
               setSelectedAvatar(param2,param3,0,false);
            }
         }
      ...
      private function handleRoomObjectMouseDown(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_15 || _loc8_ == RoomObjectCategoryEnum.const_12)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_592,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:int, param4:int, param5:String) : Boolean
      {
         ...
         switch(param5)
         {
            ...
            case RoomObjectOperationEnum.OBJECT_MOVE_TO:
               ...
               if(false)
               {
                  if(param4 == RoomObjectCategoryEnum.const_15)
                  {
      ...
      private function handleRoomActionEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            switch(param1.type)
            {
               case RoomObjectRoomActionEvent.const_450:
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_234:
               ...
               break;
            case RoomObjectStateChangeEvent.const_509:
            ...
            case RoomObjectDimmerStateUpdateEvent.DIMMER_STATE:
               ...
               break;
            case RoomObjectMoveEvent.const_331:
               handleSelectedObjectMove(param1,param2,param3);
               break;
            case RoomObjectMoveEvent.const_344:
            ...
            case RoomObjectRoomAdEvent.const_277:
               ...
               break;
            case RoomObjectRoomActionEvent.const_450:
            case RoomObjectRoomActionEvent.const_836:
            case RoomObjectRoomActionEvent.const_396:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_370:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1130));
               break;
            case RoomObjectFurnitureActionEvent.const_365:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_925));
         }
