package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_477:String = "room";
      
      private static const const_755:int = -2;
      
      private static const const_478:String = "temporary_room";
      ...
      private static const const_1099:String = "tile_cursor";
      
      private static const const_259:int = -1;
       
      
      private var var_367:IRoomObjectVisualizationFactory = null;
      ...
      private var var_456:IAdManager = null;
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_58 != null)
         {
            ...
            {
               return var_58.deleteWallItem(var_108,var_107,param1);
            }
         }
         return false;
      }
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           ...
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_560) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_602) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_117);
            if(_loc7_ != null)
            {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_58 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_12)
            {
               return var_58.modifyWallItemData(var_108,var_107,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_367 != null)
         {
            var_367.release(new IIDRoomObjectVisualizationFactory());
            var_367 = null;
         }
         if(var_34 != null)
         {
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_784;
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_896) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_889);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_347,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_512,var_108,var_107,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_58 != null)
         {
            return var_58.modifyRoomObject(var_108,var_107,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_549,param3);
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_34 != null)
         {
            var_34.addObjectUpdateCategory(RoomObjectCategoryEnum.const_15);
            ...
            var_34.addObjectUpdateCategory(RoomObjectCategoryEnum.const_236);
            var_34.addObjectUpdateCategory(RoomObjectCategoryEnum.const_40);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_58 != null)
         {
            var_58.handleRoomObjectEvent(param1,var_108,var_107);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_265,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_314,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_786,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_948,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_895,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_243,param1,param2,param3,RoomObjectCategoryEnum.const_15));
         }
         return true;
      }
      ...
      {
         if(_roomObjectFactory == null || var_367 == null || var_34 == null || _roomRendererFactory == null || _communication == null || _habboConfiguration == null || !var_2175)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_34.getRoom(getRoomIdentifier(var_108,var_107));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_754,RoomObjectCategoryEnum.const_236);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_107,var_1302);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_107,var_1302);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_367 = param2 as IRoomObjectVisualizationFactory;
         if(var_9 != null)
         {
            var_9.visualizationFactory = var_367;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(_roomObjectFactory != null)
         {
            if(false)
            {
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_234,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_509,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_73,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_365,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_331,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_344,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_251,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_376,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_278,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_277,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_450,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_836,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_396,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(AvatarWalkWarpingWarningEvent.const_387,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(var_58 != null)
         {
            return var_58.initializeRoomObjectInsert(var_108,var_107,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_243,param1,param2,param3,RoomObjectCategoryEnum.const_19));
         }
         return true;
      }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_15);
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_307);
         }
      ...
      {
         disposeObject(getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_15);
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_690)
         {
            var_2175 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_265,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_314,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_784,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_243,param1,param2,param3,RoomObjectCategoryEnum.const_12));
         }
         return true;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_456.events.addEventListener(AdEvent.const_348,showRoomAd);
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = var_34.getRoom(const_478);
         if(_loc10_ == null)
         {
            _loc10_ = var_34.createRoom(const_478,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_12:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_379,param8);
               break;
            case RoomObjectCategoryEnum.const_19:
            ...
            case RoomObjectCategoryEnum.const_40:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_123,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc21_.addPlane(RoomPlaneData.const_124,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_124,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_223,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_533,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_631,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_580,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_347,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1032.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_842,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_755,RoomObjectCategoryEnum.const_236);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1529 - _loc12_.width / 2;
            ...
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_343,var_108,var_107,-1,RoomObjectCategoryEnum.const_183));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_58 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_259,const_477);
                  var_58.handleRoomObjectEvent(_loc14_,var_108,var_107);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         else if(var_9 != null)
         {
            _loc8_ = null;
            _loc9_ = 0;
            if(param2 == RoomObjectCategoryEnum.const_15)
            {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_107,var_1302);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1529 - _loc6_.data.width / 2;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_9 != null)
         {
            ...
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_294,param1.image,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_917,param1.adWarningL,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_775,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_863,RoomObjectVariableEnum.const_294,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_9 != null)
         {
            _events.addEventListener(RoomContentLoader.const_690,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_58 != null)
         {
            var_58.cancelRoomObjectInsert(var_108,var_107);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_34.getRoom(const_478);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_842);
               ...
               _loc13_ = var_1032.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_108,var_107,const_259,RoomObjectCategoryEnum.const_40,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_848,param6,true);
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_259,const_477,_loc8_) as IRoomObjectController;
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_560,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_668,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_602,_loc19_);
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_549,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_347,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_181);
         ...
         _loc7_.createRoomObject(const_755,const_1099,RoomObjectCategoryEnum.const_236);
         _loc7_.createRoomObject(const_754,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_236);
         return _loc7_;
      }
