package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_388,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_294,"");
         _loc2_.setString(RoomObjectVariableEnum.const_569,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_388,Number(false));
         var_791 = true;
      }
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_863:
                  _loc2_.setString(RoomObjectVariableEnum.const_294,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_569,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_388,Number(true));
                  var_1020 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_932);
            }
         }
      }
