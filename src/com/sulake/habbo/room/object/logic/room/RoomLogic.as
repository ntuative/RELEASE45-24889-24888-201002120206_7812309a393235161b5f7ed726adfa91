package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1353:int = 1500;
      
      private var var_1352:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_549:
                  _loc2_.setString(RoomObjectVariableEnum.const_533,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_620:
                  _loc2_.setString(RoomObjectVariableEnum.const_631,_loc3_.value);
                  break;
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_347:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_181)
                  {
                     _loc8_ = "null";
                  }
                  var_377.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_635:
                  _loc7_ = var_377.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_377.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_828,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_798,int(_loc5_.bgOnly));
            var_1075 = _color;
            var_1352 = var_1284;
            var_899 = _loc11_;
            var_1354 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_887,param1.toString(),true);
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_70.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_61,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1259,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1287,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1236,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_61,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_123)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_124 || _loc13_ == RoomPlaneData.const_223)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_722)
         {
            ...
            {
               _loc7_ = var_1075 >> 16 & 255;
               _loc8_ = var_1075 >> 8 & 255;
               _loc9_ = var_1075 & 255;
               _loc10_ = var_899 >> 16 & 255;
               _loc11_ = var_899 >> 8 & 255;
               _loc12_ = var_899 & 255;
               _loc13_ = (_loc2_ - var_722) / var_1353;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1352 + (var_1354 - var_1352) * _loc13_;
               _color = _loc3_;
               var_1284 = _loc4_;
            }
