package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1375:Number = Math.sqrt(0.5);
      ...
      protected var var_1508:String = null;
      ...
      protected var var_2249:Number = NaN;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1508 != null && var_1508.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
      ...
      {
         var _loc3_:int = 0;
         if(var_2041 != param1 || var_2042 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_561[_loc3_] = "";
               var_560[_loc3_] = false;
               _loc3_--;
            }
            var_2041 = param1;
            var_2042 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2039 != param1 || var_2040 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(var_151 != _loc3_.getUpdateID())
         {
            var_2253 = _loc3_.getNumber(RoomObjectVariableEnum.const_184);
            ...
            var_1508 = _loc3_.getString(RoomObjectVariableEnum.const_314);
            var_151 = _loc3_.getUpdateID();
            return true;
         }
         return false;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_269 != _loc3_.getUpdateID() || param1 != var_197 || param2 != var_2249)
         {
