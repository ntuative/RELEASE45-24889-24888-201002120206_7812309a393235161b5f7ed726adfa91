package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_725:int = 15;
      
      private static const const_1029:int = 2;
      
      private static const const_326:int = 2;
      
      private static const const_726:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_936[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_937[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_936 = new Array();
         var_936.push(Math.random() * _loc2_ * 1.5);
         var_936.push(Math.random() * _loc2_ * 1.5);
         var_938 = new Array();
         var_938.push(1);
         var_938.push(-1);
         var_935 = new Array();
         var_935.push(const_1029);
         var_935.push(const_1028);
         var_937 = new Array();
         var_937.push(getRandomAmplitudeFactor());
         var_937.push(getRandomAmplitudeFactor());
      }
