package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1146:int = const_313;
      ...
      public static const const_224:int = const_85;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1524 == const_85)
         {
            _loc5_ = new Rectangle(0,0,var_23.width,var_484);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_484,var_23.width,var_484);
         }
         ...
         if(isStatic)
         {
            if(var_23 != null)
            {
               if(var_23.width == param2 && var_23.height == param3 && Vector3d.isEqual(var_764,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_484,param6,param7);
                     return param1;
                  }
                  return var_23;
               }
