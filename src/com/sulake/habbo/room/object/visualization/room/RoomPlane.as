package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_524:PlaneMaskManager = null;
      ...
      private var var_50:BitmapData = null;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_219 || _type == const_161))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_803 || false && false && !var_146 || var_524 == null)
         {
            return;
         }
         ...
         if(var_50 == null || var_50.width != _loc7_ || var_50.height != _loc8_)
         {
            if(var_50 != null)
            {
               var_50.dispose();
            ...
            var_50 = new BitmapData(_loc7_,_loc8_,true,16777215);
            var_146 = true;
         }
         if(var_146)
         {
            ...
            if(var_50 != null)
            {
               var_50.fillRect(var_50.rect,16777215);
            }
            resetTextureCache(param1);
            _loc9_ = param2.getCoordinatePosition(var_457);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_187.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_524.updateMask(var_50,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < var_246.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_50.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  var_978.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_146 = false;
         }
         combineTextureMask(param1,var_50);
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_665 != null)
         {
            return var_665.getTextureIdentifier(param1,normal);
         }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_219 || _type == const_161)
         {
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1196.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1196[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_665 != null)
            {
               _loc3_ = var_665.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1451,var_1948,var_1952,var_1949,var_1950,param2);
               if(_loc3_ != null)
               {
