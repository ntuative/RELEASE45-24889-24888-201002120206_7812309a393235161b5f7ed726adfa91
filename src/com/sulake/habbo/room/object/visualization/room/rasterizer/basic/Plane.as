package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_598:PlaneVisualization = null;
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_598 = var_353.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_598 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_353 != null)
         {
            ...
            {
               _loc1_ = var_353.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
