package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1616:int = 1;
      ...
      private const const_1615:int = 2;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_389.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_570);
         ...
         var _loc14_:Number = _loc8_ - var_1198;
         ...
         var _loc20_:Boolean = var_269 != _loc3_.getUpdateID() || var_197 != param1.scale || var_151 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_458 > 0;
         if(_loc20_ || _loc21_)
         {
            --var_458;
            _loc23_ = getTimer();
            if(var_538 != _loc7_)
            {
               for each(_loc49_ in var_389.getKeys())
               {
                  var_389.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_806.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_389.remove(_loc5_);
               var_389.add(_loc5_,_loc6_);
               var_538 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_307);
            ...
            _loc6_.setDirectionAngle(AvatarSetType.const_29,_loc25_);
            _loc6_.initActionAppends();
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_237);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_517);
            _loc6_.appendAction(AvatarAction.const_685,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_414);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_33)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_363);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_272,AvatarAction.const_1171[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_969);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_832,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_955);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_859);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_890,_loc31_);
               }
            }
            ...
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_555);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_972,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_993);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_880,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_455);
            }
            ...
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_337);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_796);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_531,_loc36_);
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_797))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_806.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
      ...
      override public function dispose() : void
      {
         ...
         if(var_389 != null)
         {
            _loc1_ = var_389.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_389.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
