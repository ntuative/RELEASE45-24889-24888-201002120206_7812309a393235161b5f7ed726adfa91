package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:* = 0;
         var _loc12_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_814);
         if(_loc12_ > 0)
         {
            _loc17_ = getTimer() - _loc12_;
            if(_loc17_ < AvatarAction.const_779)
            {
               _loc10_ = uint(int(Math.sin(Number(_loc17_) / 0 * 0) * 255));
               _loc11_ = _loc4_.getNumber(RoomObjectVariableEnum.const_800);
               var_458 = const_1063;
            }
         }
         ...
         var _loc15_:Boolean = var_269 != _loc3_.getUpdateID() || var_197 != param1.scale || var_151 != _loc4_.getUpdateID();
         var _loc16_:Boolean = _isAnimating || var_458 > 0 || _loc13_;
         if(_loc15_ || _loc16_)
         {
            _loc18_ = getTimer();
            --var_458;
            if(var_538 != _loc7_)
            {
               for each(_loc36_ in var_389.getKeys())
               {
                  var_389.remove(_loc36_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            ...
            _loc20_ = _loc4_.getNumber(RoomObjectVariableEnum.const_307);
            if(isNaN(_loc20_))
            {
               _loc20_ = _loc19_;
            }
            ...
            _loc6_.setDirectionAngle(AvatarSetType.const_29,_loc20_);
            _loc6_.initActionAppends();
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_237);
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_517);
            _loc6_.appendAction(AvatarAction.const_685,_loc21_,_loc22_);
            _loc23_ = false;
            if(_loc21_ == "lay")
            {
            ...
            _loc24_ = _loc4_.getString(RoomObjectVariableEnum.const_414);
            if(_loc24_ != null && _loc24_ != "")
            {
               _loc38_ = _loc4_.getNumber(RoomObjectVariableEnum.const_363);
               _loc39_ = 3;
               _loc40_ = _loc8_ - _loc38_;
               if(_loc40_ < _loc39_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_272,_loc24_);
               }
            }
            ...
            _loc30_ = _loc6_.getSprites().length + const_1062;
            ...
            {
               _loc29_ = null;
               _loc29_ = var_806.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc29_ != null)
               {
