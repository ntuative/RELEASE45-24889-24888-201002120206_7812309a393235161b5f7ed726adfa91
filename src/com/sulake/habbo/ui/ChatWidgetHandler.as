package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_432:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_119];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_431 != null)
         {
            ...
            {
               _loc2_ = var_431.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_119:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_431.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_620.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_266:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_79);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_79);
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_29).clone();
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_431.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_620.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_694,RoomWidgetChatSelectAvatarMessage.const_516];
      }
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_119,_container.roomSession,0,"Version 24889-24888-201002120139");
                              processEvent(_loc10_ as Event);
                              return null;
                           case ":chooser":
                              if(_container.sessionDataManager.method_2("fuse_habbo_chooser") || false && _container.inventory.clubDays > 0)
                              {
                              ...
                              return null;
                           case ":furni":
                              if(_container.sessionDataManager.method_2("fuse_furni_chooser") || false && _container.inventory.clubDays > 0)
                              {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_744 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_744);
            }
            if(var_432 == null)
            {
               var_430.x = 0;
               var_430.y = 0;
               var_430.z = 0;
               var_432 = _loc4_.getScreenPoint(var_430);
               var_744 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_430.x = 0;
            var_430.y = 0;
            var_430.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_430);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_432.x || _loc8_.y != var_432.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_432,_loc5_));
