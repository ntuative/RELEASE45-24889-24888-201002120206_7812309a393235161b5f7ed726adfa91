   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               _loc5_.setDirection(AvatarSetType.const_29,3);
               _loc2_ = _loc5_.getCroppedImage(AvatarSetType.const_29);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_178 + " " + _loc6_);
            if(var_178 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_963,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               var_178.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_485,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_395,onHelpTutorialEvent);
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_81,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_485,onFigureUpdate);
         ...
         if(var_8 != null)
         {
            (var_8 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_783,onAvatarEffectsChanged);
            (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_611,onHabboClubSubscriptionChanged);
         }
         var_178 = _container.toolbar;
         if(var_178)
         {
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_395,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_81,onHelpTutorialEvent);
         }
         var_77 = _container.catalog;
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_81:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_81));
               break;
            case HabboHelpTutorialEvent.const_395:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_371));
         }
      }
      ...
      private function onHabboClubSubscriptionChanged(param1:Event = null) : void
      {
         ...
         if(var_8 != null)
         {
            ...
            if(_container != null && false)
            {
               _loc2_ = _container.sessionDataManager.method_2("fuse_use_club_dance");
            }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_571);
         _loc1_.push(RoomWidgetDanceMessage.const_483);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_695);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_553);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_543);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_522);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_527);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_700);
         _loc1_.push(RoomWidgetStopEffectMessage.const_486);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1247);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_983);
         _loc1_.push(RoomWidgetToolbarMessage.const_491);
         _loc1_.push(RoomWidgetToolbarMessage.const_645);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_638);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1197);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_846);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_687);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_505);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_715);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_521);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1195);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_544);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_585);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_548);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_489));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetWaveMessage.const_571:
               ...
               break;
            case RoomWidgetDanceMessage.const_483:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_695:
               if(var_8 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_553:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_543:
               if(var_8 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_700:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_77 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.CATALOG_CLUB)
               {
                  var_77.openCatalogPage(CatalogPageName.const_268,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_527:
               ...
               if(var_8 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_976:
                        var_77.openCatalogPage(CatalogPageName.const_1128,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_825:
                        var_8.toggleInventoryPage(InventoryCategory.const_216);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1126:
            ...
            case RoomWidgetStopEffectMessage.const_486:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_841:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_983:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_687:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_491:
               ...
               if(var_178)
               {
                  var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_30,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_8 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
                     {
                        _loc14_ = _container.sessionDataManager.method_2("fuse_use_club_dance");
                     }
                  ...
                  if(var_77 != null && var_77.getPurse() != null)
                  {
                     _container.events.dispatchEvent(new RoomWidgetCreditBalanceUpdateEvent(var_77.getPurse().credits));
                  }
               }
            ...
            case RoomWidgetToolbarMessage.const_645:
               ...
               if(var_178 && false)
               {
                  var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_418,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_638:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_428,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_975));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_428,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1295));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_647));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_715:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_521:
            ...
            case RoomWidgetStoreSettingsMessage.const_544:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_299,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_585:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_299,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_548:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_484));
               }
               break;
            default:
