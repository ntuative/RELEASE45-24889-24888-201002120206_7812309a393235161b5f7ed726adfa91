package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_225:DesktopLayoutManager;
      ...
      private var var_1936:IHabboHelp = null;
      ...
      private var var_799:IRoomWidgetFactory = null;
      ...
      private var var_517:ISessionDataManager = null;
      
      private var var_2168:uint = 16777215;
      
      private var var_77:IHabboCatalog = null;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         var_52 = new Map();
         var_226 = new Map();
         var_225 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_267,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_354,onRoomContentLoaded);
      ...
      {
         var_178 = param1;
         var_178.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
      ...
      public function init() : void
      {
         ...
         {
            var_692 = _roomEngine.loadRoomResources(var_32.roomResources);
            if(false)
            {
               var_1300 = false;
               processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_75));
            }
         }
         if(var_456 != null && true)
         {
            var_1299 = !var_456.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_32.roomId,var_32.roomCategory,var_264[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_267,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_354,onRoomContentLoaded);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2168);
      ...
      {
         var_225.setLayout(param1,_windowManager);
         if(var_178 != null)
         {
            var_225.toolbarSize = var_178.size;
            var_225.toolbarOrientation = var_178.orientation;
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_799.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_225.addWidgetWindow(_loc2_.mainWindow);
         ...
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_225.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_225 != null)
         {
            var_225.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_482:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_297,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_1448 != null && _loc3_ == RoomObjectCategoryEnum.const_19)
               {
                  _loc7_ = var_32.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_446)
                  {
                     var_1448.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_333:
               handleRoomAdClick(param1);
               break;
            case RoomEngineObjectEvent.const_359:
            case RoomEngineObjectEvent.const_332:
               handleRoomAdTooltip(param1);
               break;
            case RoomEngineObjectEvent.const_73:
               processEvent(param1);
         }
         if(_loc4_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_225.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_32.roomId,var_32.roomCategory,RoomVariableEnum.const_709);
            _loc13_ = _roomEngine.getRoomNumberValue(var_32.roomId,var_32.roomCategory,RoomVariableEnum.const_560);
            _loc14_ = _roomEngine.getRoomNumberValue(var_32.roomId,var_32.roomCategory,RoomVariableEnum.const_668);
            _loc15_ = _roomEngine.getRoomNumberValue(var_32.roomId,var_32.roomCategory,RoomVariableEnum.const_602);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_232,canvasMouseHandler);
         _loc10_.addEventListener(WindowMouseEvent.const_34,canvasMouseHandler);
         _loc10_.addEventListener(WindowEvent.const_27,onRoomViewResized);
         ...
         _loc10_.addEventListener(WindowEvent.const_27,resizeColorizer);
         if(false)
         {
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_32 != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  {
                     _loc3_.iconState = "2";
                     var_178.events.dispatchEvent(_loc3_);
                  }
                  else
                  {
                     _loc3_.iconState = "0";
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_359:
               ...
               var_167 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_285,WindowParam.const_65) as IToolTipWindow;
               var_167.setParamFlag(WindowParam.const_32,false);
      ...
      {
         if(var_692 == null || false)
         {
            return;
         }
         var _loc2_:int = var_692.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_692.splice(_loc2_,1);
         }
         if(false)
         {
            var_1300 = true;
      ...
      {
         if(var_18 != null && var_32 != null && var_1299 && var_1300)
         {
            var_18.startSession(var_32);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_218));
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = var_225.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
