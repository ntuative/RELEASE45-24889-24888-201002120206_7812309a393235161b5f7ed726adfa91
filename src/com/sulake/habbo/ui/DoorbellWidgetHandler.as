package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_80:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_492,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_92:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_92,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_594];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_594:
      ...
      {
         return [RoomSessionDoorbellEvent.const_80,RoomSessionDoorbellEvent.const_92,RoomSessionDoorbellEvent.const_103];
      }
