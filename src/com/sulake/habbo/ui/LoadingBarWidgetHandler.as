package com.sulake.habbo.ui
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_464:
               ...
               _loc3_ = new RoomWidgetInterstitialUpdateEvent(RoomWidgetInterstitialUpdateEvent.const_75,_loc2_.image,_loc2_.clickUrl);
               _container.events.dispatchEvent(_loc3_);
               break;
            case AdEvent.const_419:
               _container.setInterstitialCompleted();
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_75:
               _container.events.dispatchEvent(param1);
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_218:
               _container.events.dispatchEvent(param1);
         }
      }
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_75);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_218);
         return _loc1_;
      }
