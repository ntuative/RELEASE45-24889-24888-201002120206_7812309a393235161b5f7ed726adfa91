package com.sulake.habbo.ui
{
   ...
   public class FurniChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         var _loc3_:* = [];
         var _loc9_:int = _container.roomEngine.getRoomObjectCount(_loc1_,_loc2_,RoomObjectCategoryEnum.const_15);
         _loc4_ = 0;
         while(_loc4_ < _loc9_)
         {
            _loc8_ = _container.roomEngine.getRoomObjectWithIndex(_loc1_,_loc2_,_loc4_,RoomObjectCategoryEnum.const_15);
            if(_loc8_ != null)
            {
               _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_265);
               ...
               _loc3_.push(new ChooserItem(_loc8_.getId(),RoomObjectCategoryEnum.const_15,_loc7_));
            }
            _loc4_++;
         }
