package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_733:uint = 11;
       
      
      private var var_210:LatencyTracker = null;
      
      private var var_209:PerformanceTracker = null;
      ...
      private var var_1164:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_209 = new PerformanceTracker();
         var_210 = new LatencyTracker();
         var_1164 = new LagWarningLogger();
         var_1165 = new Array(const_733);
         var _loc4_:int = 0;
         while(_loc4_ < const_733)
         {
            var_1165[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1114,new Date().getTime().toString());
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1222,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_538,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_815,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_670:
               trackLoginStep(HabboLoginTrackingStep.const_1142,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_176:
               trackLoginStep(HabboLoginTrackingStep.const_176);
               break;
            case HabboCommunicationEvent.const_141:
               trackLoginStep(HabboLoginTrackingStep.const_141);
               break;
            case HabboCommunicationEvent.const_146:
               setErrorContextFlag(2,0);
               trackLoginStep(HabboLoginTrackingStep.const_146);
               break;
      ...
      {
         var_77 = IHabboCatalog(param2) as IHabboCatalog;
         var_77.events.addEventListener(CatalogPageOpenedEvent.CATALOG_PAGE_OPENED,onCatalogPageOpened);
         var_77.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
         var_77.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
      }
      ...
      {
         var_158 = IHabboConfigurationManager(param2);
         if(var_158)
         {
            Component(var_158).events.addEventListener(HabboConfigurationEvent.const_156,onConfigurationLoaded);
            if(var_210 != null)
            {
               var_210.configuration = var_158;
            }
            if(var_209 != null)
            {
               var_209.configuration = var_158;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_456.events.addEventListener(AdEvent.const_348,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_815,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_538,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_670,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_176,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_146,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_141,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_195,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_648,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_45,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_387:
               var_1164.registerWarning(LagWarningLogger.const_974);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_158)
            {
               var_158.release(new IIDHabboConfigurationManager());
               var_158 = null;
            }
            if(_localization)
            {
            ...
            if(var_456)
            {
               var_456.release(new IIDHabboAdManager());
               var_456 = null;
            }
            if(_navigator)
            {
            ...
            if(var_77)
            {
               if(true)
               {
                  var_77.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
                  var_77.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
               }
               var_77.release(new IIDHabboCatalog());
               var_77 = null;
            }
            if(var_8)
            {
            ...
            if(var_157)
            {
               if(true)
               {
                  Component(var_157).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_157).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_157).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_157).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_157).events.removeEventListener(HabboFriendListTrackingEvent.const_309,onFriendlistTrackingEvent);
               }
               var_157.release(new IIDHabboFriendList());
               var_157 = null;
            }
            if(var_373)
            {
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_158)
         {
            Component(var_158).events.removeEventListener(HabboConfigurationEvent.const_156,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_900);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_900,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_949 > -1 && _loc2_ < var_949)
         {
            ++var_1414;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1414);
         }
         if(var_949 > -1 && _loc2_ - var_949 > 15000)
         {
            ++var_1415;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1415);
         }
         var_949 = _loc2_;
         if(var_209 != null)
         {
         ...
         if(var_1164 != null)
         {
            var_1164.update(param1);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_158 != null && Boolean(var_158.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      {
         var_157 = param2 as IHabboFriendList;
         Component(var_157).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_157).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_157).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_157).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_157).events.addEventListener(HabboFriendListTrackingEvent.const_309,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:int = 0;
         if(param1.critical && !var_1805)
         {
            var_1805 = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1340,new Date().getTime().toString());
            if(var_158)
            {
               if(var_158.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_158.getKey("client.fatal.error.url");
                  ...
                  if(var_209 != null)
                  {
                     _loc4_["null"] = var_209.flashVersion;
                     _loc4_["null"] = var_209.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_648)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1220);
         }
         else if(param1.type == HabboHotelViewEvent.const_405)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1179);
         }
         else if(param1.type == HabboHotelViewEvent.const_45)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1348);
         }
      }
   }
}
