package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1588:IAvatarRenderManager;
      
      private var var_1345:AvatarSearchResults;
      ...
      private var var_1589:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_356:FriendListTabs;
      
      private var var_1586:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1346:OpenedToWebPopup;
      ...
      {
         var_1589 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_311 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1345 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1346 == null)
         {
            var_1346 = new OpenedToWebPopup(this);
         }
         var_1346.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            var_356.findTab(FriendListTab.const_83).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         var_178.events.dispatchEvent(_loc1_);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_311.addCategory(new FriendCategory(FriendCategory.const_819,getText("friendlist.friends")));
         var_311.addCategory(new FriendCategory(FriendCategory.const_462,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_311.addFriend(new Friend(_loc4_));
         }
         var_356 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_87,HabboToolbarIconEnum.FRIENDLIST));
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_63);
      ...
      {
         var _loc2_:IAvatarImage = var_1588.createAvatarImage(param1,AvatarScaleType.const_79);
         return _loc2_.getCroppedImage(AvatarSetType.const_29);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1588 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = var_356.findTab(FriendListTab.const_83);
      ...
      {
         var_1586 = param2 as IHabboNotifications;
      ...
      {
         var _loc1_:String = var_158.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_356.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      {
         var_178 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         return var_158.getKey(param1,param1,param2);
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1345.searchReceived(_loc2_.friends,_loc2_.others);
