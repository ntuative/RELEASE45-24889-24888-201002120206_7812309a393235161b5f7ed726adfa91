package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1453:int = "F".charCodeAt(0);
      
      public static const const_1489:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_654 = param1.online;
         var_1235 = param1.followingAllowed && param1.online;
         var_538 = param1.figure;
         var_1237 = param1.motto;
         var_1236 = param1.lastAccess;
