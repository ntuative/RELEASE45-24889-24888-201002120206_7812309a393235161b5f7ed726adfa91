package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1525:Number = 15;
      ...
      private var var_1029:Boolean = true;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_195 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_39,HabboWindowStyle.const_774,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1029 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1029)
         {
         ...
         var_1301 = _loc7_.toolbar.@margin_bottom;
         var_1525 = _loc7_.toolbar.@min_group_margin;
         var_1526 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_265,param1,param2,_window,var_243);
         createGroupsFromXmlList(_loc9_,var_575,param1,param2,var_195,var_243);
         alignWindows();
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1525,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1301) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1525,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1301) / -1));
