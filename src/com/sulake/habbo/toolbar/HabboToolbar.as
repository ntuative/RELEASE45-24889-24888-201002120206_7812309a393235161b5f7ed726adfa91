package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_509.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_87,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_963,onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_418,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_582,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_766,onHideWindowEvent);
         var_31 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_62));
      }
