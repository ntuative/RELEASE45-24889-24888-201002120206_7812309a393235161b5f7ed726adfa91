package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1034:Number = 90;
      
      private static const const_744:int = 50;
      
      private static const const_1032:Number = 25;
      ...
      private var var_987:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_987 = param2;
         var_551 = new Timer(const_1032);
         var_551.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var_462.push(param2);
         param1.addEventListener(WindowEvent.const_362,windowEventListener);
         param1.addEventListener(WindowEvent.const_179,windowEventListener);
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_987.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_987.getIconLoc(param1.iconId);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_552[_loc3_] = new Array();
            }
            if(var_552[_loc3_].indexOf(param1) < 0)
            {
               var_552[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_744 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_744 || param1.desktop.height - param1.y < const_1069;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < var_461.length)
         {
            if(var_461[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_552[_loc3_].length)
                  {
                     repositionWindow(var_552[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
