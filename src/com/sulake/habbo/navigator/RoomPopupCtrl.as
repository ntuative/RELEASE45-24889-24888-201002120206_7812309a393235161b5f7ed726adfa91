package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1772 = new RoomThumbnailRenderer(param1);
         var_1046 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_161,var_104.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_1046.refreshTags(_loc1_,var_104.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1772.refreshThumbnail(_loc1_,var_104.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_161,var_104);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_161,!true ? getEventCtg(var_104.categoryId) : getRoomCtg(var_104.categoryId));
         refreshRoomDesc(var_161,var_104);
         refreshExtraCont();
         refreshInfo(var_161,"trading_allowed",var_104.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_196,Tabs.const_191,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
