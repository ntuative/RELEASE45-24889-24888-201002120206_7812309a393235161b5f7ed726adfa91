package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_418:IDropMenuWindow;
      ...
      {
         var _loc1_:int = var_418 == null ? 0 : int(var_418.selection);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_418 == null)
         {
            var_418 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_418.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
