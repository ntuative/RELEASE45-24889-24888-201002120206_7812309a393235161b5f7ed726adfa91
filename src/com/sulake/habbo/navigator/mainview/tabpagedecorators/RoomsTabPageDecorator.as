package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_419:IDropMenuWindow;
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = var_419 == null ? 0 : int(var_419.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_238,Tabs.const_280);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_238,Tabs.const_681);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_238,Tabs.const_280,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_419 == null)
         {
            var_419 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_419.procedure = onChangeFilter;
