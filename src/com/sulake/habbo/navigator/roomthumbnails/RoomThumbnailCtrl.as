package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1376,this._model.mode != ThumbnailEditorModel.const_36);
         setEnabled(var_1375,this._model.mode != ThumbnailEditorModel.const_16);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1376 = IButtonWindow(find("top_tab"));
         var_1375 = IButtonWindow(find("obj_tab"));
         var_1677 = IWindowContainer(find("tile_grid"));
         var_1678 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1376,onTopTabButton);
         Util.setProcDirectly(var_1375,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1677;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_1678;
