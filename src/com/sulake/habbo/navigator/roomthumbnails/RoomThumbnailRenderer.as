package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1109:int = -16;
      
      private static const const_763:int = 32;
      
      private static const const_1108:int = 8;
      
      public static const const_439:int = 10;
      
      private static const const_1110:int = 40;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_880 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_880.getImage(ThumbnailEditorModel.const_16,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1109,_loc4_.y + const_1110 - _loc5_.height),null,null,true);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_880.getImage(ThumbnailEditorModel.const_18,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_880.getImage(ThumbnailEditorModel.const_18,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_880.getImage(ThumbnailEditorModel.const_36,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_763 + _loc3_,param2 * const_1108);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1319 == null)
         {
            var_1319 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1319,var_1319.rect,new Point(0,0),null,null,true);
      }
   }
}
