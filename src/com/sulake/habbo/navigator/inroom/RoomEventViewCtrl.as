package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1495:ITextWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_680.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_841.getText());
         addTag(_loc6_,var_839.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1496.visible = true;
         var_2074.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_680.setText(param1.eventDescription);
         var_841.setText(getTagFromEvent(param1,1));
         var_839.setText(getTagFromEvent(param1,2));
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1496 = IWindowContainer(find("event_type_disabled_cont"));
            var_2074 = ITextWindow(find("event_type_disabled_text"));
            var_1497 = ITextWindow(find("create_caption"));
            var_1495 = ITextWindow(find("edit_caption"));
            var_1258 = IButtonWindow(find("create_button"));
            var_1257 = IButtonWindow(find("edit_button"));
            var_2075 = IButtonWindow(find("cancel_button"));
            var_1259 = IButtonWindow(find("end_button"));
            var_840 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1258,onCreateButtonClick);
            Util.setProcDirectly(var_1257,onEditButtonClick);
            ...
            var_680 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_841 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_839 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_680.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
