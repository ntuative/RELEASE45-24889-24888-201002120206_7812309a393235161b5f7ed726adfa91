package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_1773:ISessionDataManager;
      
      private var var_1770:RoomCreateViewCtrl;
      
      private var var_1772:RoomThumbnailRenderer;
      
      private var var_178:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1144:RoomInfoViewCtrl;
      
      private var var_77:IHabboCatalog;
      
      private var var_356:Tabs;
      
      private var var_440:MainViewCtrl;
      
      private var var_1771:Array;
      
      private var var_948:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1144 = new RoomInfoViewCtrl(this);
         var_1770 = new RoomCreateViewCtrl(this);
         var_1772 = new RoomThumbnailRenderer(this);
         var_948 = new GuestRoomPasswordInput(this);
         var_335 = new GuestRoomDoorbell(this);
         var_356 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_440.startSearch(Tabs.const_196,Tabs.const_264,param1);
      ...
      {
         if(param1 != null && var_178 != null)
         {
            var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_30,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_158.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_178 != null)
         {
            var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_87,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_87,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1773 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_440.startSearch(Tabs.const_228,Tabs.const_194);
         var_356.getTab(Tabs.const_228).tabPageDecorator.tabSelected();
      }
