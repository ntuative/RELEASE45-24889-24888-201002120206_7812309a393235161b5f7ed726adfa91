package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1163:TextFieldManager;
      ...
      private var var_1158:ICheckBoxWindow;
      ...
      private function populateForm() : void
      {
         ...
         var_778.setText(_loc1_.name);
         var_1163.setText(_loc1_.description);
         var_948.setText("");
         var_1160.setText("");
         ...
         changePasswordField(_loc1_.doorMode == RoomSettingsData.const_91);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         setCategorySelection(_loc1_.categoryId);
         refreshMaxVisitors(_loc1_);
         setTag(var_841,_loc1_.tags[0]);
         setTag(var_839,_loc1_.tags[1]);
         if(var_1158)
         {
            if(_loc1_.allowPets)
            {
               this.var_1158.select();
            }
            else
            {
               this.var_1158.unselect();
            }
         }
         if(var_1157)
         {
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         close();
         var_372.roomSettingsRefreshNeeded();
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + var_371);
         _navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",var_83.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(_navigator.getXmlWindow("ros_room_delete_confirm")),this,onConfirmRoomDelete,[var_371]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(var_238.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(var_238.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(var_238.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = var_238.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = var_238.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = var_238.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(var_238.findChildByName("flat_controllers_footer"));
         Util.hideChildren(var_238);
         var_238.findChildByName("ruler").visible = true;
         ...
         if(var_83.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(var_238,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1413.visible = _inRoom;
         var_1412.visible = _inRoom;
         var_1794.visible = var_442;
         var_1793.visible = !var_442;
         if(var_442)
         {
         ...
         else
         {
            ...
            var_1159.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1159.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_947.height = Util.getLowestPoint(this.var_947) + 4;
         }
         var_1411.text = !!var_442 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1413.name,var_1159.name,var_947.name,var_944.name,var_1161.name,var_1412.name],0,0);
      ...
      {
         this.var_371 = param1;
         _navigator.send(new GetRoomSettingsMessageComposer(var_371));
         if(var_946 != null)
         {
            var_946.visible = false;
         }
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = var_778.getText();
         _loc2_.description = var_1163.getText();
         var _loc3_:ISelectorWindow = _window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_145;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_91;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_394;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_91)
         {
            _loc8_ = var_948.getText();
            _loc9_ = var_1160.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_948.clearErrors();
               this.var_1160.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = var_1158.isSelected;
         _loc2_.allowFoodConsume = var_1157.isSelected;
         _loc2_.allowWalkThrough = var_1162.isSelected;
         _loc2_.tags = new Array();
         addTag(var_841,_loc2_.tags);
         addTag(var_839,_loc2_.tags);
         this.clearErrors();
         this.var_945 = _loc2_.roomId;
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.send(new RemoveAllRightsMessageComposer(this.var_371));
      }
      
      public function onRoomSettingsSaved(param1:int) : void
      {
         if(param1 != this.var_371 || var_945 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_945 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1194)
         {
            this.var_778.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1206)
         {
            this.var_778.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1238)
         {
            this.var_1163.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1177)
         {
            ...
            setTagError(this.var_839,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1347)
         {
            ...
            setTagError(this.var_839,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1188)
         {
            this.var_948.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_778.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_534,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_992,onDoorModePasswordUnselect);
         ...
         refreshCategories();
         this.var_778 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1163 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_841 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_839 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_948 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1160 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1158 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1157 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1162 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1413 = IWindowContainer(_window.findChildByName("header_container"));
         var_1159 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         ...
         var_1412 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1161 = IWindowContainer(_window.findChildByName("footer_container"));
         var_238 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_946 = IWindowContainer(_window.findChildByName("password_container"));
         var_1793 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1794 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1411 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1411.procedure = onSwitchView;
         var_946.visible = false;
         if(!_inRoom)
         {
