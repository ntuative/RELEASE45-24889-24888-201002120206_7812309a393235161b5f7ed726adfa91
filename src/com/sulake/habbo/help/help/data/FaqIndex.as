package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_615:FaqCategory;
      
      private var var_614:FaqCategory;
      ...
      {
         var _loc4_:* = null;
         if(var_614.hasItem(param1))
         {
            var_614.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_615.hasItem(param1))
         {
            var_615.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < var_114.length)
         {
            _loc4_ = var_114.getWithIndex(_loc3_);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_114.length)
            {
               _loc2_ = var_114.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
            var_114.dispose();
      ...
      {
         if(param1 >= var_114.length)
         {
            return null;
         }
         return var_114.getWithIndex(param1);
      }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(var_615.hasItem(param1))
         {
            return var_615.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < var_114.length)
         {
            _loc3_ = var_114.getWithIndex(_loc2_);
      ...
      public function getCategoryTitleArray() : Array
      {
         ...
         while(_loc3_ < var_114.length)
         {
            _loc2_ = var_114.getWithIndex(_loc3_);
            if(_loc2_ != null)
            {
