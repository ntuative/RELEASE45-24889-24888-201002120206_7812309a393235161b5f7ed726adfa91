package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2187:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","24889-24888-201002120139");
         var_178 = param5;
         var_98 = new Map();
         var_98.add(HabboHelpViewEnum.const_1227,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_128,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_334,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_214,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_203,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_494,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_283,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_692,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_209,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_98.add(HabboHelpViewEnum.const_918,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_696,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      public function tellUI(param1:String, param2:* = null) : void
      {
         ...
         var _loc3_:IHelpViewController = method_1();
         if(_loc3_ != null)
         {
      ...
      private function createWindow() : void
      {
         ...
         var_1538 = 0 - _loc3_.width;
         var_1539 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_266 == HabboHelpViewEnum.const_128 || false)
         {
            return;
         }
         if(var_405 == null)
      ...
      private function method_1() : IHelpViewController
      {
         return var_98.getValue(var_266);
      }
      ...
      private function removeCurrentView() : void
      {
         ...
         var _loc1_:IHelpViewController = method_1();
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
      ...
      {
         var_2186 = param1;
         var _loc2_:IHelpViewController = var_98.getValue(HabboHelpViewEnum.const_128) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_209:
               showUI(HabboHelpViewEnum.const_209);
               break;
            case CallForHelpResultEnum.const_781:
               showUI(HabboHelpViewEnum.const_918);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_266 == HabboHelpViewEnum.const_128)
         {
            return;
         }
         if(true)
         {
            ...
            var_579.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_579[1],var_579[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_579[0],var_579[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1539;
         _window.width = _loc1_.width + var_1538;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         else if(param2)
         {
            if(param1 != var_266)
            {
               var_578.push(var_266);
            }
         }
         var_266 = param1;
         var _loc4_:IHelpViewController = method_1();
         if(_loc4_ == null)
         {
         ...
         if(_loc3_)
         {
            if(var_178 != null)
            {
               var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_30,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_27.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_679));
      }
