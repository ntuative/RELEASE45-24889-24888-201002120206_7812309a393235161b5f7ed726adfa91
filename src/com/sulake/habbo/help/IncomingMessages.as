package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboHelp, param2:IHabboCommunicationManager)
      {
         ...
         _loc3_.addHabboConnectionMessageEvent(new FaqCategoryMessageEvent(method_10));
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_27.tellUI(HabboHelpViewEnum.const_203,_loc4_);
         }
      }
      ...
      private function method_10(param1:IMessageEvent) : void
      {
         ...
         var_27.tellUI(HabboHelpViewEnum.const_214,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_27.tellUI(HabboHelpViewEnum.const_128);
      }
      ...
      {
         var_27.showUI(HabboHelpViewEnum.const_283);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_27.showUI(HabboHelpViewEnum.const_334);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_27.showUI(HabboHelpViewEnum.const_494);
         var_27.tellUI(HabboHelpViewEnum.const_494,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_446)
            {
         ...
         var_27.tellUI(HabboHelpViewEnum.const_696);
      }
