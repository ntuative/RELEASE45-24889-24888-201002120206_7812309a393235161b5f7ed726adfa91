package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_910:UserDataManager;
      ...
      {
         if(var_31 == RoomSessionEvent.const_263 && _connection != null)
         {
            var_31 = RoomSessionEvent.const_74;
            if(isPrivateRoom)
            {
      ...
      {
         return var_910 as IUserDataManager;
      }
