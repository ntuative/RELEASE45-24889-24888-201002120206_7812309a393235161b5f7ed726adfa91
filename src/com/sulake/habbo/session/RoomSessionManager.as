package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_263,_loc7_));
         return true;
      }
      ...
      private function initializeManager() : void
      {
         ...
         if(initialized && var_1134)
         {
            gotoRoom(var_1756,var_1758,var_1133);
            var_1134 = false;
            var_1133 = "";
         }
      }
      ...
      private function updateHandlers(param1:IRoomSession) : void
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < var_78.length)
            {
               _loc3_ = var_78[_loc2_] as BaseHandler;
               if(_loc3_ != null)
               {
      ...
      public function startSession(param1:IRoomSession) : Boolean
      {
         ...
         {
            var_767 = false;
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_74,param1));
      ...
      private function createHandlers() : void
      {
         ...
         var_78.push(new RoomSessionHandler(_connection,this));
         var_78.push(new RoomChatHandler(_connection,this));
         var_78.push(new RoomUsersHandler(_connection,this));
         var_78.push(new RoomPermissionsHandler(_connection,this));
         var_78.push(new AvatarEffectsHandler(_connection,this));
         var_78.push(new RoomDataHandler(_connection,this));
         var_78.push(new PresentHandler(_connection,this));
         var_78.push(new PlaceObjectErrorHandler(_connection,this));
         var_78.push(new TeleportErrorHandler(_connection,this));
         var_78.push(new GenericErrorHandler(_connection,this));
         var_78.push(new PollHandler(_connection,this));
         var_78.push(new VoteHandler(_connection,this));
         var_78.push(new LidoHandler(_connection,this));
         var_78.push(new RoomDimmerPresetsHandler(_connection,this));
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_179)
         {
            while(false)
            {
               _loc1_ = var_179.getKey(0) as String;
               _loc2_ = var_179.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < var_78.length)
            {
               _loc4_ = var_78[_loc3_] as IDisposable;
               if(_loc4_)
               {
                  _loc4_.dispose();
               }
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return var_179.getValue(_loc3_) as IRoomSession;
      }
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = var_179.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = getRoomIdentifier(param3,param4);
            _loc7_ = var_179.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            var_179.add(_loc5_,_loc6_);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = var_179.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_84,_loc4_));
            _loc4_.dispose();
         }
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_839:
                  break;
               case RoomSessionHandler.const_845:
                  break;
               case RoomSessionHandler.const_525:
