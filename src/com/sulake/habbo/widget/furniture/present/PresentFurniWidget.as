package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_686,var_139);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_39,HabboWindowStyle.const_20,0 | 0,new Rectangle(const_1010,const_1011,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_177 != null)
         {
            _loc4_.caption = var_177;
         }
