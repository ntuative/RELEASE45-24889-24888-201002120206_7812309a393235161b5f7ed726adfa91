package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      {
         var _loc1_:* = null;
         if(var_203 || var_139 == -1 || !_controller)
         {
            return;
         }
         var_203 = true;
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_508,var_139);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_39,HabboWindowStyle.const_20,0 | 0,new Rectangle(const_1010,const_1011,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_177 != null)
         {
            _loc6_.caption = var_177;
         }
