package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_446:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_39,HabboWindowStyle.const_20,0 | 0,new Rectangle(const_1010,const_1011,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_446 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_446 != null)
         {
            var_446.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_955 = _loc2_.light;
         if(var_320 != null)
         {
            var_320.setValue(var_955);
         }
         var_407 = colors.indexOf(_loc2_.color);
         if(var_446 != null)
         {
            var_446.setSelectedColorIndex(var_407);
         }
