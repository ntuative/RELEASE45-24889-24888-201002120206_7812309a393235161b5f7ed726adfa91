package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1393:int = 150;
      
      private static const const_1016:int = 3000;
      
      private static const const_1017:int = 30000;
      ...
      private var var_755:Timer = null;
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         ...
         {
            var_630 = var_630 - 1;
            _visualization.showFloodBlocking(var_630);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_507,onChatInputUpdate);
      ...
      {
         var_1116 = param1.name;
      }
      
      private function onSettings(param1:RoomWidgetChatInputDisplayEvent) : void
      {
         var_1726 = param1.allowPaste;
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         {
            case RoomWidgetChatInputContentUpdateEvent.const_901:
               _loc2_ = localizations.getKey("widgets.chatinput.mode.whisper",":tell");
               _visualization.displaySpecialChatMessage(_loc2_,param1.userName);
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1282:
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_507,onChatInputUpdate);
      ...
      private function checkForFlooding() : Boolean
      {
         ...
         if(var_365 > const_1015)
         {
            if(_loc1_ < var_1115 + const_1016)
            {
               var_756 = true;
               var_630 = const_1017 / 1000;
               Logger.log("Enabling flood blocking");
               var_755 = new Timer(1000,var_630);
               var_755.addEventListener(TimerEvent.TIMER,onReleaseTimerTick);
               var_755.addEventListener(TimerEvent.TIMER_COMPLETE,onReleaseTimerComplete);
               var_755.start();
               if(_visualization != null)
               {
                  _visualization.showFloodBlocking(var_630);
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_604,_visualization.window);
         if(messageListener != null)
         {
