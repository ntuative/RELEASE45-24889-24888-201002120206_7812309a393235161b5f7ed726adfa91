package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_472:int = 16;
      
      private static const const_1003:int = 20;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_896 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1570 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1569 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_599 = new Timer(1000,1);
         var_599.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_717 = new Timer(5000,1);
         var_717.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_27,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_136,onInputChanged);
         _window.addEventListener(WindowEvent.const_362,onWindowMoved);
         var_1069 = true;
         var_112 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1568 = _loc2_.width + const_472 + _loc6_.width + const_1003;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1004,_loc8_.width) + const_472);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_896 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_112 = "";
               }
      ...
      public function method_4(param1:Number) : void
      {
         var_402 = param1 - var_1568;
         var _loc2_:ITextFieldWindow = _window.findChildByName("chat_input") as ITextFieldWindow;
         if(_loc2_ == null)
         {
            return;
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         method_4(_window.context.getDesktopWindow().width - 0);
      }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_420);
