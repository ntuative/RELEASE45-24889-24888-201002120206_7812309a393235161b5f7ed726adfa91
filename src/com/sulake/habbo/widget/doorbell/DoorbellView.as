package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var _loc1_:XmlAsset = var_335.assets.getAssetByName("doorbell") as XmlAsset;
         var_46 = (var_335.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_46 == null)
         {
      ...
      {
         var _loc6_:* = null;
         var _loc3_:XmlAsset = var_335.assets.getAssetByName("doorbell_list_entry") as XmlAsset;
         var _loc4_:IWindowContainer = var_335.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         if(_loc4_ == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function update() : void
      {
         ...
         if(var_44 != null)
         {
            ...
            _loc1_ = 0;
            while(_loc1_ < var_335.users.length)
            {
               var_44.addListItem(createListItem(var_335.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
