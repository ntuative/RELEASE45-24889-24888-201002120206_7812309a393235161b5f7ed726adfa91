package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_472:int = 6;
      
      private static const const_324:int = 10;
      
      private static const const_1067:Number = 18;
      ...
      {
         _widget.onItemMouseOut(var_980,var_981,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_980,var_981,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1200 = param1.chatType;
         var_980 = param1.userId;
         var_809 = param1.userName;
         var_981 = param1.userCategory;
         _message = param1.text;
         var_1201 = param1.userX;
         var_188 = param1.userImage;
         var_982 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1200)
         {
            case RoomWidgetChatUpdateEvent.const_96:
               _loc1_ = "bubble_speak";
               break;
            case RoomWidgetChatUpdateEvent.const_90:
               _loc1_ = "bubble_whisper";
               break;
            case RoomWidgetChatUpdateEvent.const_82:
               _loc1_ = "bubble_shout";
               break;
         ...
         if(var_188 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_386 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_982 != 0)
            {
               _loc30_ = uint(var_982 >> 16 & 255);
               _loc31_ = uint(var_982 >> 8 & 255);
               _loc32_ = uint(var_982 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_324;
            }
            else
            {
               _loc19_.text = var_809 + ":";
               _loc19_.y += var_386;
               _loc19_.width = _loc19_.textWidth + const_324;
               _width += _loc19_.textWidth + const_324;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1200 == RoomWidgetChatUpdateEvent.const_252)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_809);
            }
            else if(var_1200 == RoomWidgetChatUpdateEvent.const_239)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_809);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_386;
            _loc20_.width = _loc20_.textWidth + const_472;
            _width += _loc20_.textWidth + const_472;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_324 + _loc20_.textWidth + const_472;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_980,var_981,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_980,var_981,_roomId,_roomCategory,param1);
      }
