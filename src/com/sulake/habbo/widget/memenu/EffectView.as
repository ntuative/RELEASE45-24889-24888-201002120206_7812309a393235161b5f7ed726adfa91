   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_773 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_156.duration);
               var_773.width = _loc2_ * var_402;
            }
            else
            {
               var_773.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_774 = _window.findChildByName("effect_hilite");
            var_774.visible = false;
         }
         var_772 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_773 = _window.findChildByName("loader_bar");
         if(var_773 != null)
         {
            var_402 = var_773.width;
            var_164.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_156.icon);
         }
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_772 != null)
         {
            var_772.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_772.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
