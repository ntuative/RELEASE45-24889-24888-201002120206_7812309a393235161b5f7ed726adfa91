package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1613:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1197 != null && var_1197.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_102);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_804 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_804 += param1.height + const_1614;
            return fit(param1);
         }
         param1.offset(_offsetX,var_804);
         _offsetX += param1.width + const_1613;
         return true;
      }
