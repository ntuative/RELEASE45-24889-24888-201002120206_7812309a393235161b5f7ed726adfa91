package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1610:uint = 6710886;
      ...
      private const const_1606:String = "energy";
      ...
      private const const_1611:uint = 3355443;
      
      private var var_228:IBorderWindow;
      
      private const const_1605:int = 158;
      
      private const const_1604:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_242:PetCommandTool;
      
      private const const_1609:uint = 11184810;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_228 != null)
         {
            var_99 = var_228.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         ...
         for each(_loc8_ in _loc7_)
         {
            ...
            _loc8_.addEventListener(WindowEvent.const_27,onButtonResized);
         }
      }
      ...
      {
         if(var_99 == null || var_228 == null || var_53 == null)
         {
            return;
         }
         ...
         var_228.height = NaN;
         _window.width = Math.max(var_228.width,var_53.width);
      ...
      private function openTrainView() : void
      {
         if(var_242 == null)
         {
            var_242 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1119.getValue(var_683) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_242.showWindow(true);
            var_242.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1606,param1.energy,param1.energyMax);
         ...
         updateWindow();
         var_683 = param1.id;
         var_1119.remove(param1.id);
         var_1119.add(param1.id,param1);
         if(var_242 && var_242.isVisible() && param1.isOwnPet)
         {
            var_242.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_242.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_457,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1605,const_1604,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1609);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1611);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1610);
         return _loc5_;
      }
