package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
            ...
            if(_loc2_)
            {
               ...
               while(_loc3_ < _loc2_.numListItems)
               {
                  ...
                  if(_loc4_)
                  {
                     ...
                     if(_loc5_)
                     {
                        if(_loc5_.testStateFlag(WindowState.const_28))
                        {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_621[var_920] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_274)
         {
            ...
            var_274 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_274.center();
            var_274.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_920;
         if(var_920 < var_621.length)
         {
            _loc1_ = var_621[var_920] as Dictionary;
            if(!_loc1_)
            {
