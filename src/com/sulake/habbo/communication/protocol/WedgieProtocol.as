package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1218:uint = 1;
      
      public static const const_1337:uint = 2;
       
      
      private var var_754:IProtocolDecoder;
      
      private var var_929:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_929 = new WedgieEncoder();
         var_754 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1218)
            {
               _loc4_.position = 0;
               _loc6_ = var_754.getID(_loc4_);
