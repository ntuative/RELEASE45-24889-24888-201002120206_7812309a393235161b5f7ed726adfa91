package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private const const_1392:String = "fuselogin";
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_927)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_141);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_262:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_965:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_883:
               _loc3_ = _habboConfiguration.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_941:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1693)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_628 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_628);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_146);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1110,var_1694));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1392,"/");
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1392,"/");
      ...
      {
         var_628 = _habboConfiguration.getKey("sso.ticket",null);
         var_1110 = _habboConfiguration.getKey("flash.client.url","");
         var_1694 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_154 == null)
         {
         ...
         if(var_628 != null)
         {
            var_61.mode = HabboConnectionType.const_408;
            var_61.initConnection(HabboConnectionType.const_217);
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_670);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         switch(var_61.mode)
         {
            case HabboConnectionType.const_408:
               ...
               break;
            case HabboConnectionType.const_1224:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1232:
               var_926 = generateRandomHexString(30);
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_84,onRoomSessionEnded);
      }
