package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_339.shockwaveClientUrl = var_109.shockwaveClientUrl;
         var_339.ssoTicket = var_109.ticket;
         var_109.removeEventListener(SSOTicket.const_300,onParsedTicketSuccess);
         var_109.removeEventListener(SSOTicket.const_257,onParsedTicketFailure);
         var_109 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1392,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_339.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_434,HabboWindowStyle.const_23,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1392,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_109 = new SSOTicket(var_339.assets,_loc2_,_loc1_);
         var_109.addEventListener(SSOTicket.const_300,onParsedTicketSuccess);
         var_109.addEventListener(SSOTicket.const_257,onParsedTicketFailure);
      }
