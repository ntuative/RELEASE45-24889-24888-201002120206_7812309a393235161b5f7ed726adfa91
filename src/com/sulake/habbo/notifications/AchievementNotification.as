package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1572 = param2;
         var_517 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_88,onBadgeImageReady);
         ...
         var_177 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1910 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_177);
      ...
      public function dispose() : void
      {
         if(var_517 != null)
         {
            var_517.events.removeEventListener(BadgeImageReadyEvent.const_88,onBadgeImageReady);
            var_517 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_660,var_1910);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_660,var_660));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_660,var_660));
         _localizations.registerParameter(param1,"level",var_1572.toString());
         _localizations.registerParameter(param1,"name",var_517.userName);
         _localizations.registerParameter(param1,"realname",var_517.realName);
      }
   }
}
