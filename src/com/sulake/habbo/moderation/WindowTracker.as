package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_562:int = 4;
      ...
      public static const const_833:int = 5;
      ...
      {
         var_1432 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1432[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1432[param1] = _loc2_;
         }
         return _loc2_;
      }
