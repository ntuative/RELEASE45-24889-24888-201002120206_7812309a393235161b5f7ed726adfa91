package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_915:String = "issue_bundle_open";
      
      public static const const_556:String = "issue_bundle_my";
      
      public static const const_940:String = "issue_bundle_picked";
      ...
      private var var_51:ModerationManager;
      ...
      private var var_520:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_116 = new Map();
         var_748 = new Map();
         var_520 = new IssueBrowser(this,var_51.windowManager,var_51.assets);
         var_624 = [];
         var_747 = [];
         var_923 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_923.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         var _loc2_:* = [];
         var _loc3_:int = var_51.sessionDataManager.userId;
         for each(_loc4_ in var_116)
         {
            switch(param1)
            {
               case const_915:
                  if(_loc4_.state == IssueMessageData.const_127)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      {
         var _loc2_:IssueBundle = var_116.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
         sendPick(_loc2_.getIssueIds());
         var_624 = var_624.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var_141.remove(param1.issueId);
         var_141.add(param1.issueId,param1);
         var _loc2_:int = int(var_748.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = var_116.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     var_116.remove(_loc3_.id);
                     removeHandler(_loc3_.id);
                  }
                  var_748.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1135)
         {
            var_141.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_116)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_748.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_748.add(param1.issueId,_loc2_);
            var_116.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(var_624.indexOf(param1.issueId) != -1)
         {
            handleBundle(_loc3_.id);
         }
         if(param1.state == IssueMessageData.const_127)
         {
            _loc5_ = getBundles(const_556);
            _loc6_ = false;
            ...
            _loc8_ = var_747.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = new IssueHandler(var_51,_loc2_);
         var_923.remove(param1);
         var_923.add(param1,_loc3_);
         var_51.windowTracker.show(_loc3_,null,false,false,false);
         var_624 = [];
      }
      
      private function sendClose(param1:Array, param2:int) : void
      {
         if(param1 == null || var_51 == null || true)
         {
            return;
         }
         var_51.connection.send(new CloseIssuesMessageComposer(param1,param2));
      }
      ...
      private function sendPick(param1:Array) : void
      {
         ...
         var_51.connection.send(new PickIssuesMessageComposer(param1));
      }
      ...
      public function releaseAll() : void
      {
         ...
         var _loc1_:int = var_51.sessionDataManager.userId;
         var _loc2_:* = [];
      ...
      {
         if(param1 == null || param1.length == 0 || var_51 == null || true)
         {
            return;
         }
         var_51.connection.send(new ReleaseIssuesMessageComposer(param1));
         var_747 = var_747.concat(param1);
      }
      
      public function closeBundle(param1:int, param2:int) : void
      {
         var _loc3_:IssueBundle = var_116.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:* = var_923.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function updatePriorities() : void
      {
         ...
         var _loc3_:int = parseInt(var_51.configuration.getKey("chf.score.updatefactor","60"));
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_116.getValues();
         for each(_loc3_ in _loc1_)
         {
            if(_loc3_.state == IssueMessageData.const_127 && (_loc2_ == null || _loc3_.getPrioritySum() > _loc2_.getPrioritySum()))
            {
               _loc2_ = _loc3_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_51.soundManager.playSound(HabboSoundTypesEnum.const_824);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_748.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_116.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_116.getValues();
         var _loc4_:int = var_51.sessionDataManager.userId;
