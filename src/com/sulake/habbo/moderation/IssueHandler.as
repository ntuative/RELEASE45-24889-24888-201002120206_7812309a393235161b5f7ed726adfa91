package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_51.issueManager.releaseBundle(var_106.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc1_:XmlAsset = var_51.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         _window = var_51.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(_window == null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(WindowEvent.const_27,onResized);
         }
         ...
         var_51.disableButton(var_51.initMsg.chatlogsPermission,_window,"show_chatlog");
         ...
         var_397 = new UserInfoCtrl(_window,var_51,_loc3_.message);
         var_1025 = new UserInfoCtrl(_window,var_51,_loc3_.message);
         var_397.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_106.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1025.load(_loc4_,var_106.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_51.issueManager.closeBundle(var_106.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:XmlAsset = var_51.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:IWindowContainer = var_51.windowManager.buildFromXML(_loc2_.content as XML) as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_51.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_51,WindowTracker.const_970,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_51 != null && false && var_106 != null)
         {
            var_51.issueManager.removeHandler(var_106.id);
         }
         this.dispose();
      }
      ...
      {
         if(_window == null || var_51 == null || true)
         {
            return;
         }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_51.issueManager.closeBundle(var_106.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_51.issueManager.closeBundle(var_106.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateMessages() : void
      {
         ...
         _loc1_.removeListItems();
         var _loc2_:XmlAsset = var_51.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:ITextWindow = var_51.windowManager.buildFromXML(_loc2_.content as XML) as ITextWindow;
         if(_loc3_ == null)
         {
            return;
         }
