package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl
   {
      ...
      private function onUserinfoButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_43.windowTracker.show(new UserInfoFrameCtrl(var_43,_userId),var_46,false,false,true);
      }
      ...
      private function onRoomToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_43.windowTracker.show(new RoomToolCtrl(var_43,_roomId),var_46,false,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_43.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!var_1315 ? 0 : 1,_roomId),var_43,WindowTracker.const_562,_roomId),var_46,false,false,true);
      }
      ...
      {
         if(var_43.initMsg.chatlogsPermission)
         {
      ...
      public function show() : void
      {
         if(var_46 == null)
         {
            var_46 = IFrameWindow(var_43.getXmlWindow("start_panel"));
            ...
            var_43.disableButton(var_43.initMsg.cfhPermission,var_46,"ticket_queue_but");
