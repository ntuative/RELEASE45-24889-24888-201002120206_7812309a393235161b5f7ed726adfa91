package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         _id = param1;
         var_141 = new Map();
         var_141.add(param2.issueId,param2);
         var_31 = param2.state;
         var_1863 = param2.pickerUserId;
         var_1864 = param2.pickerUserName;
         var_990 = param2.reportedUserId;
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         ...
         var _loc1_:IssueMessageData = var_141.getWithIndex(0);
         var _loc3_:int = 1;
      ...
      {
         return var_141.remove(param1) as IssueMessageData;
      }
