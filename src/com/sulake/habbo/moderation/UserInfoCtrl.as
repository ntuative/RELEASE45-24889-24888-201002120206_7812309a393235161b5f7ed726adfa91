package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_727:int = 31536000;
      
      private static const const_730:int = 86400;
      
      private static const const_728:int = 3600;
      
      private static const const_729:int = 60;
      ...
      {
         if(param1 < 2 * const_729)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_728)
         {
            return Math.round(param1 / const_729) + " mins ago";
         }
         if(param1 < 2 * const_730)
         {
            return Math.round(param1 / const_728) + " hours ago";
         }
         if(param1 < 2 * const_727)
         {
            return Math.round(param1 / const_730) + " days ago";
         }
         return Math.round(param1 / const_727) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_43.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_43,WindowTracker.const_833,_data.userId),_callerFrame,var_940,false,true);
      }
      ...
      private function prepare() : IWindowContainer
      {
         ...
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_43.getXmlWindow("user_info"));
            var_766.addChild(_loc1_);
            var_43.disableButton(var_43.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            var_43.disableButton(var_43.initMsg.alertPermission,_loc1_,"message_but");
            var_43.disableButton(var_43.initMsg.alertPermission || var_43.initMsg.kickPermission || var_43.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_43.windowTracker.show(new ModActionCtrl(var_43,_data.userId,_data.userName,var_1208),_callerFrame,var_940,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_43.openHkPage("habboinfotool.url",_data.userName);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_43.windowTracker.show(new RoomVisitsCtrl(var_43,_data.userId),_callerFrame,var_940,false,true);
      }
      ...
      {
         var_43.openHkPage("moderatoractionlog.url",_data.userName);
      }
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         _data = null;
         refresh();
         var_43.messageHandler.addUserInfoListener(this);
         var_43.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      public function dispose() : void
      {
         ...
         _disposed = true;
         var_43.messageHandler.removeUserInfoListener(this);
         _callerFrame = null;
         var_43 = null;
         _data = null;
         var_766 = null;
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_43.windowTracker.show(new SendMsgsCtrl(var_43,_data.userId,_data.userName,var_1208),_callerFrame,var_940,false,true);
      }
