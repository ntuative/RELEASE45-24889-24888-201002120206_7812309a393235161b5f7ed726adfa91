package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_43.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_43,WindowTracker.const_562,_data.flatId),var_46,false,false,true);
      }
      ...
      private function setSendButtonState(param1:String) : void
      {
         ...
         if(_loc2_ && var_43.initMsg.roomAlertPermission)
         {
            _loc3_.enable();
         }
         else
      ...
      {
         Logger.log("MSG TEMPLATES: " + var_43.initMsg.roomMessageTemplates.length);
         param1.populate(var_43.initMsg.roomMessageTemplates);
      }
      ...
      public function dispose() : void
      {
         ...
         _disposed = true;
         var_43.messageHandler.removeRoomEnterListener(this);
         if(var_46 != null)
         {
            var_46.destroy();
            var_46 = null;
      ...
      private function refreshRoomData(param1:RoomData, param2:String) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = IWindowContainer(var_43.getXmlWindow("roomtool_roomdata"));
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_371);
         if(param1.flatId != var_371)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_371);
            return;
         }
         _data = param1;
         populate();
         var_43.messageHandler.removeRoomInfoListener(this);
         var_46.visible = true;
         var_43.messageHandler.addRoomEnterListener(this);
      ...
      private function onEditInHk(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_43.openHkPage("roomadmin.url","undefined");
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_43.windowTracker.show(new UserInfoFrameCtrl(var_43,_data.ownerId),var_46,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var_43.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1209,_loc2_,var_387.text,"",""));
         if(false)
         {
            var_43.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1002.isSelected,var_1001.isSelected,var_674.isSelected));
         }
         this.dispose();
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_43.initMsg.roomMessageTemplates["null"];
         if(_loc3_ != null)
         {
            var_287 = false;
            var_387.text = _loc3_;
      ...
      public function populate() : void
      {
         ...
         var_674 = ICheckBoxWindow(var_46.findChildByName("kick_check"));
         var_1002 = ICheckBoxWindow(var_46.findChildByName("lock_check"));
         var_1001 = ICheckBoxWindow(var_46.findChildByName("changename_check"));
         ...
         var_43.disableButton(var_43.initMsg.bobbaFilterPermission,var_46,"bobba_filter_but");
         var_43.disableButton(var_43.initMsg.chatlogsPermission,var_46,"chatlog_but");
         if(!var_43.initMsg.roomKickPermission)
         {
            var_674.disable();
         }
      ...
      private function onBobbaFilter(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_43.openHkPage("wordfilter.url","");
      }
      
      public function show() : void
      {
         var_46 = IFrameWindow(var_43.getXmlWindow("roomtool_frame"));
         var_43.messageHandler.addRoomInfoListener(this);
         var_43.connection.send(new GetModeratorRoomInfoMessageComposer(var_371));
         Logger.log("BEGINNING TO SHOW: " + var_371);
      }
   }
}
