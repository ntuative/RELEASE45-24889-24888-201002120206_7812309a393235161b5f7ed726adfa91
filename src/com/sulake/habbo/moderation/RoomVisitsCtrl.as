package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         onResizeTimer(null);
         var_46.visible = true;
         var_43.messageHandler.removeRoomVisitsListener(this);
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2170.clone());
         ...
         new OpenRoomTool(var_46,var_43,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
         ...
         new OpenRoomInSpectatorMode(var_43,_loc7_,param1.isPublic,param1.roomId);
         _loc7_.color = _loc4_;
      ...
      {
         var_2170 = IWindowContainer(var_43.getXmlWindow("roomvisits_row"));
         var_424 = new Timer(300,1);
         var_424.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_43.messageHandler.addRoomVisitsListener(this);
         var_43.connection.send(new GetRoomVisitsMessageComposer(_userId));
         var_46 = IFrameWindow(var_43.getXmlWindow("roomvisits_frame"));
