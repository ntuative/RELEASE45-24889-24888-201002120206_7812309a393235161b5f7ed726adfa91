package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_704["null"] = new AvatarEditorGridView(param1,FigureData.const_98,param2,param3);
         var_704["null"] = new AvatarEditorGridView(param1,FigureData.const_133,param2,param3);
         var_704["null"] = new AvatarEditorGridView(param1,FigureData.const_131,param2,param3);
         var_704["null"] = new AvatarEditorGridView(param1,FigureData.const_118,param2,param3);
         var_704["null"] = new AvatarEditorGridView(param1,FigureData.const_126,param2,param3);
         attachImages();
         switchCategory(FigureData.const_98);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "tab_accessories":
                  ...
                  break;
               case "tab_eyewear":
                  switchCategory(FigureData.const_118);
                  break;
               case "tab_masks":
