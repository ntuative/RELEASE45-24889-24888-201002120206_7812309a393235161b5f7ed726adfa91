package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         var_2083 = parseInt(_loc2_,16);
         var_2082 = parseInt(_loc3_,16);
         ...
         _colorTransform = new ColorTransform(var_1551,var_1553,var_1552,_alphaMultiplier);
         var_1011 = generatePaletteMapForGrayscale(var_2082,var_2083);
      }
      
      public function get reds() : Array
      {
         return var_1011.getValue("reds") as Array;
      }
      ...
      {
         return var_1011.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1011.getValue("greens") as Array;
      }
      ...
      {
         return var_1011.getValue("alphas") as Array;
      }
