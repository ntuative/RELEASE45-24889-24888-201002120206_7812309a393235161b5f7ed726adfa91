package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private var var_783:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1171.width,var_1171.height,true,0);
            _loc4_ = var_1171.clone();
            _loc4_.colorTransform(_loc4_.rect,var_783.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_952.width,var_952.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_952,var_952.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
