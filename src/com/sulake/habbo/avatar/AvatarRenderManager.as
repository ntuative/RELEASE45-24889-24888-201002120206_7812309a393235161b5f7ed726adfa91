package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1039:PaletteManager;
      
      private var var_707:PetDataManager;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_296.getValue(AvatarType.const_70) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      private function init() : void
      {
         ...
         var_707 = new PetDataManager(_loc1_,_loc3_);
         var_1039 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_707.populateFigureData(_loc4_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.const_70);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_296.add(AvatarType.const_70,_loc5_);
      ...
      {
         return var_707 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_677 = param1;
         if(var_677 == RenderMode.const_1149)
         {
            init();
         }
      }
      ...
      {
         var _loc5_:String = var_707.createAvatarFigureStringNew(param1,param2,param3);
      ...
      {
         var _loc3_:AvatarStructure = var_296.getValue(AvatarType.const_70) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_16,param1,param2,AvatarType.const_70);
      }
