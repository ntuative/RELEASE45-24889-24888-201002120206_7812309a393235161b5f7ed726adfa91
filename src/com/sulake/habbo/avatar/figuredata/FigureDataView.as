package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1226 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_474 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_474.bitmap = new BitmapData(var_474.width,var_474.height,true,16777215);
         var_474.bitmap.copyPixels(var_1226,var_1226.rect,new Point(0,0 - 0 - 8));
         var_474.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
