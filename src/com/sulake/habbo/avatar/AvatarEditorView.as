package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1535:ITabSelectorWindow;
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_638 != null)
         {
            toggleCategoryView(var_638,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1535 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_638 = param1;
         var_1535.setSelected(var_1535.getSelectableByName(param1));
         _window.invalidate();
      }
