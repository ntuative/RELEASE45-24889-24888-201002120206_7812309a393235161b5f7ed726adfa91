package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_905:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_905.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_907)
         {
            ...
            var_612["null"] = new FigureData(this);
            var_612["null"] = new FigureData(this);
            _loc1_ = var_612["null"];
            _loc2_ = var_612["null"];
            _loc1_.loadAvatarData("hr-681-35.hd-209-7.ch-878-87.lg-281-70.sh-906-77.ea-1401-77.ha-1010-70.he-1601-62.fa-1204-62.ca-1809-62.wa-2007-62",FigureData.const_66);
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_64);
            var_311 = new Map();
            var_311.add(AvatarEditorCategory.const_869,new GenericModel(this));
            var_311.add(AvatarEditorCategory.const_29,new HeadModel(this));
            var_311.add(AvatarEditorCategory.const_292,new TorsoModel(this));
            var_311.add(AvatarEditorCategory.const_1121,new LegsModel(this));
            var_311.add(AvatarEditorCategory.const_689,new WardrobeModel(this));
            var_907 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_311.getValue(AvatarEditorCategory.const_689);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_311.getValue(AvatarEditorCategory.const_689);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_905.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1292)
               {
                  _loc19_ = true;
               }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_869);
         if(var_158 != null)
         {
            urlString = var_158.getKey("avatar.editor.url");
            try
            {
            }
            catch(e:Error)
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1084 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_611,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_905 = var_1084.getFigureData(AvatarType.const_70);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_906 = param3;
         var _loc4_:FigureData = var_612[param2];
         if(_loc4_ == null)
         {
            return;
         }
