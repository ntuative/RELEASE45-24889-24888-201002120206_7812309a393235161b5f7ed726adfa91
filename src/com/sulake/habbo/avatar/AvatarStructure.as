package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_354:PartSetsData;
      
      private var var_1573:PartOffsetData;
      
      private var var_718:AvatarActionManager;
      
      private var var_137:IAssetLibrary;
      
      private var var_2257:IAssetLibrary;
      
      private var var_1339:Boolean = false;
      
      private var var_1574:AvatarRenderManager;
      ...
      private var var_1341:AvatarStructureDownloadSet;
      
      private var var_601:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_137 = param2;
         var_2257 = param3;
         var_421 = new FigureData();
         var_354 = new PartSetsData();
         _animationData = new AnimationData();
         var_1341 = new AvatarStructureDownloadSet();
         var_601 = new AnimationManager();
         var_600 = param4;
      ...
      {
         return var_718.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_600)
         {
            case AvatarType.const_70:
               _loc1_ = var_137.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_354.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_137.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_137.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_421.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_137.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_354.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_137.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_137.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_421.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_718.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_718.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_601.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_354.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_354.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1191[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_718.getDefaultActionType();
         var _loc7_:Array = var_354.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_601.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_421.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_421.getPalette(_loc23_.paletteID);
               if(_loc24_)
               {
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_354.getPartDefinition(_loc26_.type);
                           _loc30_ = _loc13_ == null ? _loc26_.type : _loc13_.method_7;
                           if(_loc30_ == "")
                           {
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_354.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_70:
               if(var_137.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_137.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_137.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_137.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      private function onStructureReady(param1:Event = null) : void
      {
         ...
         {
            var_354.getPartDefinition("ri").appendToFigure = true;
            var_354.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_70:
               var_1341.add(new AvatarStructureDownload(var_137,_loc5_,var_421));
               break;
            case AvatarType.PET:
         }
         var_1341.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_601.getAnimation(param1);
      }
      ...
      {
         var_718 = new AvatarActionManager(var_137,var_600);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_137.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_137.getAssetByName("dance" + _loc1_).content as XML;
            var_601.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_137.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_137.getAssetByName("fx" + _loc1_).content as XML;
            var_601.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_601.getLayerData(param1,param2,param3);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_421.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_421.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_718.sortActions(param1);
      }
   }
}
