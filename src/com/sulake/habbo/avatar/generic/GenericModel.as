package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericModel implements IAvatarEditorCategoryModel
   {
      ...
      private function init() : void
      {
         ...
         var_311["null"] = _controller.generateDataContent(this,FigureData.const_37);
      ...
      public function categorySwitch(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FigureData.const_66:
               _controller.gender = FigureData.const_66;
               break;
      ...
      private function updateCategoryData(param1:String) : void
      {
         ...
         for each(_loc5_ in _loc4_.data)
         {
            ...
            _loc5_.iconImage = _loc7_.getCroppedImage(AvatarSetType.const_29).clone();
            _loc7_.dispose();
         }
      }
