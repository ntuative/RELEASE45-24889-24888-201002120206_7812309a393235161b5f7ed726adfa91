package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1639 = parseInt(param1.@precedence);
         var_1640 = String(param1.@activepartset);
         var_1637 = String(param1.@assetpartdefinition);
         var_1641 = String(param1.@lay);
         var_1316 = String(param1.@geometrytype);
         var_1643 = Boolean(parseInt(param1.@main));
         var_1642 = Boolean(parseInt(param1.@method_7));
         var_1644 = Boolean(parseInt(param1.@animation));
