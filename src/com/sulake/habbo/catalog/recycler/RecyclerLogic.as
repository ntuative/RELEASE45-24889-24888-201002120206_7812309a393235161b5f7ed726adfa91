package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_748:int = 0;
      
      public static const const_142:int = 5;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1498)
         {
            case RecyclerStatusMessageEvent.const_1162:
               ...
               var_77.setupInventoryForRecycler(true);
            ...
            case RecyclerStatusMessageEvent.const_979:
               ...
               var_77.setupInventoryForRecycler(false);
               break;
      ...
      {
         var_253 = const_747;
         var_91 = new Array(const_142);
         if(param1 == null)
         {
            return;
         }
         _view = param1;
         var_77.getRecyclerStatus();
      }
      ...
      public function storePrizeTable(param1:Array) : void
      {
         ...
         {
            _loc3_ = new PrizeLevelContainer(param1[_loc2_],var_77);
            var_631.push(_loc3_);
            _loc2_++;
         }
      }
      ...
      {
         return active && var_253 == const_327;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(false)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_142)
            {
         ...
         var itemId:int = var_77.requestInventoryFurniToRecycler();
         if(itemId == 0)
         {
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_907:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1355:
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!var_77.returnInventoryFurniFromRecycler(var_91[param1].id))
         {
            return;
         }
         var_91[param1] = null;
