package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1008:Number = 4285716709;
      ...
      private var var_2263:IWindowContainer;
      ...
      private var var_1360:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1360 == 4294967295)
            {
               var_1360 = _loc1_.color;
            }
            _loc1_.color = const_1008;
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1361) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_44 = navigator.catalog.windowManager.buildFromXML(var_1359) as IItemListWindow;
         if(var_44 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1363;
            }
         }
      }
