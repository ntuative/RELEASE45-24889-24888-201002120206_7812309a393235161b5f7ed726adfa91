package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_77.configuration.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = var_77.configuration.getKey("link.format.credits","/credits");
            var_77.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
      ...
      {
         var_77.openCatalogPage(var_2324,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var_77.loadCatalogPage(param1.pageId);
         var_77.events.dispatchEvent(new CatalogPageOpenedEvent(param1.pageId,param1.localization));
      }
      ...
      public function openFrontPage() : void
      {
         ...
         var_77.loadCatalogPage(_loc1_.pageId);
      }
      ...
      public function openPage(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_77.loadCatalogPage(_loc2_.pageId);
         }
