package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1298:EventDispatcher;
      ...
      {
         return _localization.hasLinks(var_863);
      }
      ...
      private function createWidgets() : void
      {
         ...
         if(_loc1_ != null)
         {
            var_52.push(new ClubGiftWidget(_loc1_,var_77.getClubGiftController()));
         }
         for each(_loc2_ in var_52)
         {
            _loc2_.page = this;
            _loc2_.events = var_1298;
            _loc2_.init();
         }
         var_1298.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1298.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_863);
      }
