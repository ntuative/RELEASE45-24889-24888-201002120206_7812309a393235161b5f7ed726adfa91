package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1278:IScrollbarWindow;
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_415:
                  ...
                  if(var_568 != null)
                  {
                     ...
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_568,var_1278,var_1324);
                  }
                  break;
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_174:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_29,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_272,AvatarAction.const_487);
      ...
      override public function init() : void
      {
         ...
         var_1507 = new Point(var_80.x,var_80.y);
         var_568 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1278 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_568 == null)
         {
