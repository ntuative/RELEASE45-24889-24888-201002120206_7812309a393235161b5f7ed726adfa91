package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_1093:MarketPlaceOfferData;
      ...
      private function updateList(param1:Map) : void
      {
         ...
         if(!var_427)
         {
            ...
            var_427 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_427)
         {
            return;
         ...
         if(!var_361)
         {
            var_361 = new Timer(25);
            var_361.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_740 = 0;
         populateList();
         var_361.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_514)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_427 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_427.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1390);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      override public function dispose() : void
      {
         ...
         if(var_361)
         {
            var_361.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_361 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_740 >= var_514.length)
            {
               return true;
            }
            addListItem(var_514.getWithIndex(var_740));
            ++var_740;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_1093.offerId);
                  hideDetails();
            }
            return;
         }
