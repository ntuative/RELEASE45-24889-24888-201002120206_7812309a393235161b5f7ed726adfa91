package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_956 != null)
         {
            var_956.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_957 != null)
         {
            var_957.removeEventListener(WindowKeyboardEvent.const_129,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_956 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_956 != null)
         {
            var_956.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_957 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_957 != null)
         {
            var_957.addEventListener(WindowKeyboardEvent.const_129,windowKeyEventProcessor);
         }
      }
