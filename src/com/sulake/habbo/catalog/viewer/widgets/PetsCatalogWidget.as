package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_407 >= var_297.length)
         {
            return "";
         }
         var petColor:IPetColor = var_297[var_407] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_582[var_1549] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_407 < 0 || var_407 > var_297.length)
         {
            var_407 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_514.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         var_879 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_297 = [];
         var_582 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_879);
               if(_loc11_)
               {
         ...
         while(_loc6_ < var_582.length)
         {
            ...
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_879,_loc12_.id),getRaceLocalizationKey(var_879,_loc12_.id)));
            _loc6_++;
         }
         var_514.add(var_879,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_886,onApproveNameResult);
         _loc5_ = var_514.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_514.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_407 >= 0 && var_407 < var_297.length)
         {
            _loc7_ = var_297[var_407] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_582[var_1549] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_879,_loc3_.id,_loc2_,AvatarScaleType.const_33);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_272,AvatarAction.const_550);
