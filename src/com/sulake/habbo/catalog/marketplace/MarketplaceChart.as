package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1016 + var_1016 / -var_2322 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_845 - var_845 / var_394 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_394).toString().length - 1);
         var_394 = Math.ceil(var_394 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_394.toString();
         _loc3_.draw(_loc6_);
         var_1016 = param1 - _loc6_.textWidth - 2;
         ...
         while(_loc10_ <= 5)
         {
            ...
            _loc9_.graphics.lineTo(var_1016 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1016,(param2 - var_845) / 2));
         return _loc3_;
      }
