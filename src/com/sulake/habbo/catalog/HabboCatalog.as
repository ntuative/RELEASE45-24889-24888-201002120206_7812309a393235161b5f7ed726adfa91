package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_93:IMarketPlace;
      ...
      private var var_283:CatalogViewer;
      ...
      private var var_965:ClubGiftController;
      ...
      {
         return var_517.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_185.credits = _loc3_.balance;
         updatePurse();
         if(!var_1871 && var_800 != null)
         {
            var_800.playSound(HabboSoundTypesEnum.const_835);
         }
         var_1871 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_517.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_58)
         {
            _loc3_ = var_517.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_74:
               var_1184 = param1.session.isPrivateRoom;
               if(var_79 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_158.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_158.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(var_178 != null && _loc2_)
         {
            var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_30,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_965.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_378 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_185.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_185.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_965 == null)
         {
            var_965 = new ClubGiftController(this);
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_93.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_93 == null)
         {
            var_93 = new MarketPlaceLogic(this,_windowManager,_roomEngine);
         }
      }
      ...
      {
         var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_87,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_378.buildCatalogIndex(_loc2_);
         if(var_966 != "")
         {
            var_378.openPage(var_966);
            var_966 = "";
         }
         else
         {
            var_378.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_144)
         {
            _loc3_ = var_158.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(param1 == null || var_283 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_283.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_185.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_185.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_185.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_185.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_283.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_185.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1872 && var_800 != null)
         {
            var_800.playSound(HabboSoundTypesEnum.const_949);
         }
         var_1872 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_283.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_283.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_283 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_283.habboCatalog = this;
      }
