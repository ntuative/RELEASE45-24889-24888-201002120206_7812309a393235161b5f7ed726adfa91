package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1388:uint = 4.294967295E9;
      
      private const const_1387:uint = 4.293848814E9;
      ...
      public function receiverNotFound() : void
      {
         ...
         var_77.windowManager.alert("${catalog.gift_wrapping.receiver_not_found.title}","${catalog.gift_wrapping.receiver_not_found.info}",0,alertHandler);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         var _loc2_:XmlAsset = var_77.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return null;
         }
         return var_77.windowManager.buildFromXML(_loc2_.content as XML);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_202.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_738;
               }
            }
            _loc4_++;
         }
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = var_77.getProductData(var_68.localizationId);
         var _loc2_:String = _loc1_ == null ? "" : _loc1_.name;
         var_77.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.costs","offer_name",_loc2_);
         var _loc3_:String = "";
         var _loc4_:String = "";
         var _loc7_:String = var_77.getPurse().credits.toString();
         var _loc8_:String = var_77.getPurse().pixels.toString();
         ...
         var_77.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.costs","price",_loc3_);
         var_77.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.amount","amount",_loc4_);
      }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_738,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1387) : uint(const_1388);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1364;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = var_77.getFurnitureData(_loc6_,ProductTypeEnum.const_59);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               var_77.purchaseProduct(var_606,var_68,var_909);
               dispose();
               break;
            case "cancel_button":
      ...
      {
         if(var_202 == null || true)
         {
            return;
         }
         var _loc1_:IItemListWindow = var_202.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_233) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_738);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_513[var_175]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_512[var_176]);
         var_77.purchaseProductAsGift(var_606,var_68,var_909,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_34:
               ...
               break;
            case WindowKeyboardEvent.const_581:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_233 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_233 + 1);
                     break;
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = var_77.getProductData(var_68.localizationId);
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_174:
                  _loc7_ = var_77.getPixelEffectIcon(_loc6_.productClassId);
                  break;
               case ProductTypeEnum.const_339:
                  _loc7_ = var_77.getSubscriptionProductIcon(_loc6_.productClassId);
            }
            if(_loc5_ != null)
            {
               _loc7_ = _loc5_.data;
      ...
      private function showGiftDialog() : void
      {
         ...
         var _loc1_:GiftWrappingConfiguration = var_77.giftWrappingConfiguration;
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1364 = _loc1_.stuffTypes;
            var_513 = _loc1_.boxTypes;
            var_512 = _loc1_.ribbonTypes;
            var_738 = var_1364[0];
            var_175 = var_513[0];
            var_176 = var_512[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_202.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_233) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_233);
         }
         var_233 = param1;
         if(var_233 < 0)
         {
            var_233 = _loc2_.numListItems - 1;
         }
         if(var_233 >= _loc2_.numListItems)
         {
            var_233 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_233) as IWindowContainer;
      ...
      private function setBitmapData(param1:IWindowContainer, param2:String, param3:String, param4:ColorTransform = null) : void
      {
         ...
         var _loc6_:BitmapDataAsset = var_77.assets.getAssetByName(param3) as BitmapDataAsset;
         if(_loc6_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_202 == null)
         {
            var_202 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_426 == null)
         {
            var_426 = createWindow("suggestion_list_item") as IWindowContainer;
            var_426.procedure = suggestionsEventHandler;
         }
         if(var_202 == null || var_426 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_202.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_426.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
