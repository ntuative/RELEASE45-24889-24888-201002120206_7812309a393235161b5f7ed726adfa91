package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         var_8 = param1;
         var_22 = var_8.communication;
         var_22.addHabboConnectionMessageEvent(new FurniListEvent(method_11));
         var_22.addHabboConnectionMessageEvent(new FurniListInsertEvent(onFurniListInsert));
         var_22.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
         var_22.addHabboConnectionMessageEvent(new FurniListUpdateEvent(onFurniListUpdate));
         var_22.addHabboConnectionMessageEvent(new PostItPlacedEvent(onPostItPlaced));
         var_22.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(onAvatarEffects));
         var_22.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(onAvatarEffectActivated));
         var_22.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(onAvatarEffectAdded));
         var_22.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(onAvatarEffectExpired));
         var_22.addHabboConnectionMessageEvent(new HabboActivityPointNotificationMessageEvent(onPixelBalance));
         var_22.addHabboConnectionMessageEvent(new CreditBalanceEvent(onCreditsBalance));
         var_22.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(onClubStatus));
         var_22.addHabboConnectionMessageEvent(new BadgesEvent(onBadges));
         var_22.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(onUserBadges));
         var_22.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(onAchievementReceived));
         var_22.addHabboConnectionMessageEvent(new AchievementsEvent(onAchievements));
         var_22.addHabboConnectionMessageEvent(new TradingAcceptEvent(onTradingAccepted,TradingAcceptParser));
         var_22.addHabboConnectionMessageEvent(new TradingConfirmationEvent(onTradingConfirmation,TradingConfirmationParser));
         var_22.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(onTradingAlreadyOpen,TradingAlreadyOpenParser));
         var_22.addHabboConnectionMessageEvent(new TradingCloseEvent(onTradingClose,TradingCloseParser));
         var_22.addHabboConnectionMessageEvent(new TradingCompletedEvent(onTradingCompleted,TradingCompletedParser));
         var_22.addHabboConnectionMessageEvent(new TradingItemListEvent(onTradingItemList,TradingItemListParser));
         var_22.addHabboConnectionMessageEvent(new TradingNotOpenEvent(onTradingNotOpen,TradingNotOpenParser));
         var_22.addHabboConnectionMessageEvent(new TradingOpenEvent(onTradingOpen,TradingOpenParser));
         var_22.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         var_22.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         var_22.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(onRoomClosed));
         var_22.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(onRoomClosed));
         var_22.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(onRoomClosed));
         var_22.addHabboConnectionMessageEvent(new PetInventoryEvent(onPets));
         var_22.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(onPetAdded));
         var_22.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(onPetRemoved));
         var_22.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(onPetInventoryUpdated));
         var_22.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(onMarketplaceConfiguration));
         var_22.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(onMarketplaceCanMakeOfferResult));
         var_22.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(onMarketplaceMakeOfferResult));
         var_22.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(onMarketplaceItemStats));
         var_22.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(onNotEnoughCredits));
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_605);
         _loc2_.refreshViews();
         var_8.notifyChangedEffects();
      }
      ...
      private function getConnection() : IConnection
      {
         ...
         return var_22.getHabboMainConnection(null);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_8.setInventoryCategoryInit(InventoryCategory.const_304);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_8.toggleInventorySubPage(InventorySubCategory.const_225);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_8.setInventoryCategoryInit(InventoryCategory.const_216);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_444);
         var _loc4_:FurniModel = var_8.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
