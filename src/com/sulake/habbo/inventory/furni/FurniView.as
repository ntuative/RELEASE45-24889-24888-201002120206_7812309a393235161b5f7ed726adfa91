package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_616:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_492 = new Map();
         var_492.add(FurniModel.const_24,new FurniGridView(_model,FurniModel.const_24,_windowManager,_assetLibrary,_roomEngine));
         var_492.add(FurniModel.const_25,new FurniGridView(_model,FurniModel.const_25,_windowManager,_assetLibrary,_roomEngine));
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_492.getValue(var_491);
         if(_loc4_ != null)
         {
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.getGroupItemInIndex(_loc3_,var_491);
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_616 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
