package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_74,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_84,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_345,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_84:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_345:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_39.getValue(InventoryCategory.const_605));
      }
      ...
      {
         var_185.clubPeriods = param1;
         var_185.clubDays = param2;
         var_185.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_39.getValue(InventoryCategory.const_139));
      }
      ...
      {
         return AchievementsModel(var_39.getValue(InventoryCategory.const_304));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_225:
      ...
      {
         return TradingModel(var_39.getValue(InventorySubCategory.const_225));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_517 = ISessionDataManager(param2);
      ...
      {
         return var_185.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_39.getValue(InventoryCategory.const_444) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1368 = new IncomingMessages(this);
      ...
      {
         return var_185.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_185.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_39.getValue(InventoryCategory.const_216));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_74,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_84,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_345,roomSessionEventHandler);
         ...
         var_39.add(InventoryCategory.const_444,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_517);
         var_39.add(InventoryCategory.const_216,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_39.add(InventoryCategory.const_605,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_517);
         var_39.add(InventoryCategory.const_304,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_39.add(InventorySubCategory.const_225,_loc8_);
         ...
         var_39.add(InventoryCategory.const_139,_loc10_);
