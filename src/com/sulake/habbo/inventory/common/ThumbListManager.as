package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_86 = var_543.height;
         var_964 = param5;
         var_789 = param6;
         var_211 = Math.floor(var_964 / _thumbWidth);
         var_15 = new BitmapData(var_964,var_789);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < var_448 - 1)
         {
            ...
            var_15.fillRect(new Rectangle(0,0 - var_86,var_15.width,var_86),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_15.width,0 - var_86);
               _loc2_ = new Rectangle(0,0,var_15.width,0 - var_86);
               _loc11_.copyPixels(var_15,_loc2_,new Point(0,0),null,null,true);
               var_15 = _loc11_;
               --var_448;
            }
         }
         if(var_15.height < var_789)
         {
            _loc12_ = new BitmapData(var_15.width,var_789);
      ...
      public function updateImageFromList() : void
      {
         ...
         var_15 = new BitmapData(Math.max(var_211 * _thumbWidth,var_964),Math.max(var_448 * var_86,var_789),true,16777215);
            ...
            while(_loc4_ < var_211)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_15.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_86),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_211 && var_15.height < _loc3_.y * var_86)
         {
            _loc2_ = new BitmapData(var_15.width,var_15.height + var_86);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_211 - 1),var_86);
         _loc2_.copyPixels(var_15,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_211 - 1),0,_thumbWidth,var_15.height);
         _loc2_.copyPixels(var_15,_loc4_,new Point(0,var_86),null,null,true);
         _loc4_ = new Rectangle(0,var_86,_thumbWidth * (var_211 - 1),0 - var_86);
         _loc2_.copyPixels(var_15,_loc4_,new Point(_thumbWidth,var_86),null,null,true);
         var_15 = _loc2_;
      }
