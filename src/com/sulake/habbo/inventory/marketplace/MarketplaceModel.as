package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = var_219 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,var_219.ref));
         releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = var_219 is FloorItem ? 1 : 2;
         var_2062 = _loc2_;
         var_2064 = var_219.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,var_219.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1490,var_1489);
         }
      }
      ...
      {
         if(param1 != var_2062 || param2 != var_2064)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_2058);
      }
      ...
      {
         if(_controller != null && false && var_219 != null)
         {
            _controller.furniModel.removeLockFrom(var_219.id);
            var_219 = null;
         }
      }
