package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_572:MessengerView;
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_770,_loc2_.senderId,getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function startConversation(param1:int) : void
      {
         var _loc2_:Conversation = var_571.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_571.setSelected(_loc2_);
            var_572.openMessenger();
            var_572.refresh(true);
         }
      }
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = var_158.getKey("url.prefix",_loc2_);
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         return _loc2_.getImage(AvatarSetType.const_29);
      }
      ...
      {
         var_571.addMessageAndUpdateView(param1);
         if(!var_572.isMessengerOpen())
         {
      ...
      {
         var_571 = new Conversations(new ConversationsDeps(this));
         var_572 = new MessengerView(this);
      ...
      {
         var_571.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_158,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_87,HabboToolbarIconEnum.MESSENGER));
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_557,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         var_571.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var_571.addMessageAndUpdateView(_loc3_);
      }
