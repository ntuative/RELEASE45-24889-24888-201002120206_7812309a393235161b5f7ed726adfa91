package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1985:BitmapData = null;
      ...
      private var var_1983:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_348,0,0,_loc4_,var_1458,var_1983,var_1985));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1984 = int(_config.getKey("interstitial.interval","30000"));
         var_1986 = int(_config.getKey("interstitial.show.time","5000"));
         var_1460 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1458 = _loc2_.clickUrl;
         if(var_1209 != "" && var_1458 != "")
         {
            _loc3_ = var_1209;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(var_1210 != "")
         {
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_26,interstitialLoaderEventHandler);
         }
         else
         {
            stopInterstitial();
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_464,0,0,param1.bitmapData,var_1987));
            var_668 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1985 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1460 > 0 && var_1459 >= var_1460)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_668;
         if(_loc1_ > var_1984)
         {
            ++var_1459;
      ...
      {
         var_509 = param2 as IHabboCommunicationManager;
         if(var_509 == null)
         {
            return;
         }
         _connection = var_509.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_419));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1983 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
