package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         _type = param3;
         var_13 = param5;
         var_31 = WindowState.const_67;
         var_73 = param4;
         var_594 = param8 == null ? new Array() : param8;
         _context = param6;
         var_5 = param7.clone();
         var_348 = param7.clone();
         var_47 = param7.clone();
      ...
      public function method_4(param1:int) : int
      {
         var _loc2_:int = 0;
