package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1433:String = "_INCLUDE";
      
      public static const const_803:String = "_EXCLUDE";
      
      public static const const_1556:String = "_TEMP";
      
      private static const const_1097:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1098:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1064,var_1065);
         var_893 = new Dictionary();
         var_1338 = new Dictionary();
         ParamCodeTable.fillTables(var_893,var_1338);
         var_1337 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1098,"");
         return param1.replace(const_1097,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1064)
            {
               delete var_1064[_loc1_];
            }
            ...
            for(_loc1_ in var_1338)
            {
               delete var_1338[_loc1_];
            }
            var_1337.dispose();
            var_1337 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_803) == -1)
                  {
