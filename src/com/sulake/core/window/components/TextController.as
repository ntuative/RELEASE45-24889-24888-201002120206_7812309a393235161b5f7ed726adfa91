package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      {
         return new Rectangle(var_588 * maxScrollH,var_345 * maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_792,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_637,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_637,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_38,true));
         _loc1_.push(new PropertyStruct("margin_left",var_59.left,PropertyStruct.const_46,true));
         _loc1_.push(new PropertyStruct("margin_top",var_59.top,PropertyStruct.const_46,true));
         _loc1_.push(new PropertyStruct("margin_right",var_59.right,PropertyStruct.const_46,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_59.bottom,PropertyStruct.const_46,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_637,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
