package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1057:String = "_HEADER";
      
      private static const const_738:String = "margin_right";
      ...
      private static const const_736:String = "margin_left";
      
      private static const const_737:String = "margin_bottom";
      ...
      private var var_1178:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_736,_loc3_.left,PropertyStruct.const_46,_loc2_));
         _loc1_.push(new PropertyStruct(const_739,_loc3_.top,PropertyStruct.const_46,_loc2_));
         _loc1_.push(new PropertyStruct(const_738,0 - _loc3_.right,PropertyStruct.const_46,_loc2_));
         _loc1_.push(new PropertyStruct(const_737,0 - _loc3_.bottom,PropertyStruct.const_46,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_172);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_201);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_172,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_172,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1178 == null)
         {
            var_1178 = findChildByTag(const_1057) as IHeaderWindow;
            if(!var_1178)
            {
      ...
      public function get content() : IWindowContainer
      {
         if(var_17 == null)
         {
            var_17 = findChildByTag(const_1056) as IWindowContainer;
            if(!var_17)
            {
