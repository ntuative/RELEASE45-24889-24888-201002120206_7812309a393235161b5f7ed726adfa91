package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_781:IItemListWindow;
      
      private var var_318:IScrollbarWindow;
      
      private var var_1417:Boolean = true;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_318)
         {
            var_318 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_318)
            {
               var_318.addEventListener(WindowEvent.const_253,scrollBarEventProc);
               var_318.addEventListener(WindowEvent.const_179,scrollBarEventProc);
            }
         }
         return var_318;
      }
      ...
      override public function dispose() : void
      {
         if(var_318)
         {
            var_318.removeEventListener(WindowEvent.const_253,scrollBarEventProc);
            var_318.removeEventListener(WindowEvent.const_179,scrollBarEventProc);
            var_318 = null;
         }
         if(var_781)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_179)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_781)
         {
            var_781 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_781;
      }
