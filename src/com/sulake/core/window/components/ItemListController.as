package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1002:String = "resize_on_item_update";
      
      protected static const const_1001:String = "spacing";
      
      protected static const const_1373:Boolean = false;
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1000:String = "scale_to_fit_items";
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1374:Boolean = true;
      
      protected static const const_999:String = "auto_arrange_items";
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_81 = 0;
         var_60 = 0;
         _horizontal = param2 == WindowType.const_273;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_149 = var_716 || !testParamFlag(WindowParam.const_14);
         _container = _context.create("_CONTAINER","",WindowType.const_302,WindowStyle.const_285,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_27,containerEventHandler);
         _container.addEventListener(WindowEvent.const_336,containerEventHandler);
         _container.addEventListener(WindowEvent.const_293,containerEventHandler);
         _container.addEventListener(WindowEvent.const_460,containerEventHandler);
      ...
      {
         return new Rectangle(var_502 * maxScrollH,var_503 * maxScrollV,width,height);
      }
      ...
      {
         _container.removeEventListener(WindowEvent.const_27,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_336,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_293,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_460,containerEventHandler);
         super.dispose();
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_502 = param1;
            _container.x = -var_502 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1001,_spacing,PropertyStruct.const_46,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_999,var_715,PropertyStruct.const_38,var_715 != const_1374));
         _loc1_.push(new PropertyStruct(const_1000,var_504,PropertyStruct.const_38,var_504 != const_1373));
         _loc1_.push(new PropertyStruct(const_1002,var_1061,PropertyStruct.const_38,var_1061 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      private function containerEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case WindowEvent.const_460:
               updateScrollAreaRegion();
               break;
            case WindowEvent.const_27:
               dispatchEvent(new WindowEvent(WindowEvent.const_27,this,null));
               break;
            default:
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_349,param1);
            }
            else
            {
