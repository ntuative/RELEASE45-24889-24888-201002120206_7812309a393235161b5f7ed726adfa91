package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_1563:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1563 == null)
         {
            var_1563 = findChildByTag(TabContextController.const_1079) as IWindowContainer;
         }
         return var_1563;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_891 == null)
         {
            var_891 = findChildByTag(TabContextController.const_1078) as ITabSelectorWindow;
            if(var_891 != null)
            {
      ...
      {
         return !!var_791 ? selector.iterator : null;
      }
