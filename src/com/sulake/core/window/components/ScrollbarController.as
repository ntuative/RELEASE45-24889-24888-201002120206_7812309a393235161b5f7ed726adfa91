package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1018:String = "increment";
      
      private static const const_467:String = "slider_bar";
      
      private static const const_1019:String = "decrement";
      
      private static const const_721:String = "slider_track";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_467:
      ...
      {
         return findChildByName(ScrollbarController.const_721) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_19 != null && true)
         {
            IWindow(var_19).removeEventListener(WindowEvent.const_27,onScrollableResized);
         }
         var_19 = param1;
         if(var_19 != null && true)
         {
            IWindow(var_19).addEventListener(WindowEvent.const_27,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_467) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_759 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_759 != null)
         {
            _loc1_ = findParentByName(var_759) as IScrollableWindow;
            if(_loc1_ == null && var_6 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_759) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1018)
            {
               if(var_19)
               {
                  var_525 = true;
            ...
            else if(param2.name == ScrollbarController.const_1019)
            {
               if(var_19)
               {
                  var_525 = true;
            ...
            else if(param2.name == ScrollbarController.const_721)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_467).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_773)
         {
