package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2079 = new Dictionary();
         TypeCodeTable.fillTables(var_1499,var_2079);
         var_1261 = new Dictionary();
         var_2078 = new Dictionary();
         StateCodeTable.fillTables(var_1261,var_2078);
         ...
         var_475["MouseCursorType"] = NullSkinRenderer;
         if(var_352 == null)
         {
            var_352 = new Array();
            var_352.push(WindowState.const_41);
            var_352.push(WindowState.const_48);
            var_352.push(WindowState.const_69);
            var_352.push(WindowState.const_28);
            var_352.push(WindowState.const_57);
            var_352.push(WindowState.const_55);
            var_352.push(WindowState.const_76);
            var_352.push(WindowState.const_67);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1261)
         {
            _loc3_.push(var_1261[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1499[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_563[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_563[param1] = new Array(SkinContainer.const_1077);
         }
         var_563[param1][param2] = param3;
      }
      ...
      {
         var _loc1_:* = null;
         for(_loc1_ in var_563)
         {
            ISkinRenderer(var_563[_loc1_]).dispose();
            delete var_563[_loc1_];
         }
