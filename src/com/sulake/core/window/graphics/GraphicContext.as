package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1511:uint = 128;
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_150 = new Sprite();
            var_150.name = this.name + " - Child Container";
            var_150.mouseEnabled = false;
            addChild(var_150);
         }
         return var_150;
      }
         ...
         if(var_592)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1561,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1561,16777215);
                  }
                  var_351 += bitmap.width * bitmap.height * 4;
               }
