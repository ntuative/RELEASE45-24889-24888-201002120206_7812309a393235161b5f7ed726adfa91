package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      public static var var_1554:IMouseCursor;
      ...
      protected var var_2246:IWindowFactory;
      ...
      protected var var_2247:IWindowParser;
      
      protected var var_889:Error;
      
      protected var var_2248:IInternalWindowServices;
      
      protected var var_89:WindowController;
      
      protected var var_1329:int = -1;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_299 = param5;
         var_2248 = new InternalWindowServices(this,param5);
         var_2246 = param3;
         var_2247 = new WindowParser(this);
         var_604 = new Date();
         if(var_991 == null)
         {
            var_991 = new Factory();
         ...
         var_82 = new DesktopController("_CONTEXT_DESKTOP_" + _name,this,param6);
         var_299.addChild(var_82.getDisplayObject());
         var_299.doubleClickEnabled = true;
         var_299.addEventListener(Event.RESIZE,stageResizedHandler);
         var_89 = WindowController(var_82);
      ...
      public function destroy(param1:IWindow) : Boolean
      {
         ...
         if(param1.state != WindowState.const_451)
         {
            param1.destroy();
         }
         return true;
      ...
      public function create(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:Rectangle, param7:Function, param8:IWindow, param9:uint, param10:Array = null, param11:Array = null) : IWindow
      {
         ...
         var _loc13_:IWindow = new _loc12_(param1,param3,param4,param5,this,param6,param8 != null ? param8 : var_82,param7,param10,param11,param9);
      ...
      public function dispose() : void
      {
         ...
         var_299.removeChild(IGraphicContextHost(var_82).getGraphicContext(true) as DisplayObject);
         var_82.destroy();
         var_82 = null;
         var_1062.destroy();
         var_1062 = null;
      ...
      private function stageResizedHandler(param1:Event) : void
      {
         if(var_82 != null && true)
         {
            if(var_299 is Stage)
            {
               var_82.width = Stage(var_299).stageWidth;
               var_82.height = Stage(var_299).stageHeight;
            }
            else
            {
               var_82.width = var_299.width;
               var_82.height = var_299.height;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         while(true)
         {
            ...
            if(_loc2_.stageX != var_553.x || _loc2_.stageY != var_553.y)
            {
               var_553.x = _loc2_.stageX;
               var_553.y = _loc2_.stageY;
               _loc5_ = new Array();
               var_82.groupChildrenUnderPoint(var_553,_loc5_);
            }
      ...
      public function getMouseCursor() : IMouseCursor
      {
         if(var_1554 == null)
         {
            var_1554 = new MouseCursorControl(var_299 as Stage);
         }
         return var_1554;
      }
      ...
      {
         return var_82.findChildByName(param1);
      }
