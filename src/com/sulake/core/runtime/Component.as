package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1432:uint = 1;
      ...
      protected var var_1889:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_889 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_889);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1066 & const_810)
         {
            if(_loc3_ == 0)
            {
