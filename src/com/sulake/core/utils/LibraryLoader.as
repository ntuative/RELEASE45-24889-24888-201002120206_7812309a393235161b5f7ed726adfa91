package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1381:int = 5;
      
      protected static const const_1107:uint = 7;
      
      protected static const const_1379:uint = 4;
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               debug("Load event STATUS " + var_350 + " for file \"" + var_14.contentLoaderInfo.url + "\"");
               break;
            case Event.UNLOAD:
         ...
         if(var_417 == LibraryLoader.const_1378)
         {
            if(analyzeLibrary())
            {
               var_417 |= 0;
         ...
         if(var_417 == LibraryLoader.const_1107)
         {
            var_1339 = true;
            prepareLibrary();
            removeEventListeners();
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_895 > 0)
            {
               var_14.close();
               var_14.unload();
               addRequestCounterToUrlRequest(var_303,const_1381 - var_895);
