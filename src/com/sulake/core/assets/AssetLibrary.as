package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_795:String = "AssetLibraryReady";
      
      public static const const_1274:String = "AssetLibraryUnloaded";
      
      public static const const_390:String = "AssetLibraryLoaded";
      
      public static const const_1134:String = "AssetLibraryLoadError";
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_392)
         {
            _loc2_ = var_392[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_392[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_682)
         {
            delete var_682[_loc1_];
         }
         if(var_14 != null)
         {
            var_14.dispose();
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(var_477)
         {
            AssetLibrary.fetchLibraryContents(this,var_476,var_328);
         }
         var_289 = true;
         dispatchEvent(new Event(AssetLibrary.const_390));
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_392[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_26,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_844,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_790,assetLoadEventHandler);
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1134));
      }
      ...
      {
         var _loc2_:Class = var_682[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_14 == null)
            {
               var_14 = new LibraryLoader(var_1326);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_392[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_13:
               ...
               if(decl != null)
               {
                  ...
                  {
                     asset.dispose();
                     e = new AssetLoaderEvent(AssetLoaderEvent.const_26,e.status);
                     break;
                  }
                  if(true)
                  {
               ...
               break;
            case AssetLoaderEvent.const_26:
               remove = true;
         }
