package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_761:XML = null;
      
      private var var_31:int = 0;
      
      private var var_102:IRoomManagerListener;
      ...
      private var var_437:IRoomObjectFactory = null;
      
      private var var_1487:int;
      
      private var var_2334:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_438 = [];
         var_436 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_267,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_354,onContentLoaded);
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_367.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_367.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = var_437.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_437 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = var_436.indexOf(param1);
         if(_loc2_ < 0)
         {
            return;
         }
         var_436.splice(_loc2_,1);
         var _loc3_:int = -1;
         while(_loc3_ >= 0)
         {
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_437 != null)
         {
            return var_437.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(var_102 != null)
            {
               var_102.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(var_102 != null)
            {
               var_102.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(var_102 != null)
         {
            var_102.contentLoaded(_loc2_,true);
         }
         if(false)
         {
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_37.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(false)
            {
               ...
               if(var_102 != null)
               {
                  var_102.roomManagerInitialized();
               }
            }
         }
         else
         {
            var_31 = const_636;
            var_102.roomManagerInitialized(false);
         }
      }
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = var_367.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_367.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_437.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(var_102 != null)
                                 {
                                    var_102.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
