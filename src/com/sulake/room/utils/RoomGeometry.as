package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_768:Number = 32;
      ...
      {
         if(var_384 != param1 * var_1445)
         {
            var_384 = param1 * var_1445;
            ++var_71;
         }
      }
      ...
      {
         if(var_382 != param1 * var_1443)
         {
            var_382 = param1 * var_1443;
            ++var_71;
         }
      }
      ...
      {
         if(var_383 != param1 * var_1444)
         {
            var_383 = param1 * var_1444;
            ++var_71;
         }
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         if(_loc3_ < var_2318 || _loc3_ > var_2319)
         {
            return null;
         }
      ...
      {
         return new Vector3d(0 * var_382,0 * var_383,0 * var_384);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_181;
         var _loc6_:Number = -param1.y / var_181;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_74,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_382,0 * var_383,0 * var_384);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_75;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_382,param2.y * var_383,param2.z * var_384);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_382,param3.y * var_383,param3.z * var_384);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_382,param4.y * var_383,param4.z * var_384);
