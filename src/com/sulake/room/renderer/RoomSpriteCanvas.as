package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_720:int = 50;
      ...
      private var var_743:RoomObjectLocationCache;
      ...
      private var var_1681:Number = -10000000;
      ...
      private var var_918:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_743 = new RoomObjectLocationCache(_loc6_);
         var_272 = new Map();
      ...
      public function update() : void
      {
         if(var_917 == 0)
         {
            checkMouseHits(var_919.x,var_919.y,MouseEvent.MOUSE_MOVE);
         }
         var_917 = 0;
         ++var_1377;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_234 != null)
         {
            var_234.graphics.clear();
         }
         else
         {
            var_234 = new Sprite();
            var_234.name = "mask";
            _master.addChild(var_234);
         }
         var_234.graphics.beginFill(0);
         var_234.graphics.drawRect(0,0,param1,param2);
         var_915 = param1;
         var_916 = param2;
         var_42.graphics.clear();
         var_42.graphics.beginFill(var_2317);
      ...
      {
         var _loc11_:Number = param1 - var_915 / 2;
      ...
      public function render(param1:int) : void
      {
         ...
         if(_loc6_ < var_273.length)
         {
            var_273.splice(_loc6_);
         }
         var_273.sortOn("z",0 | 0);
         var _loc10_:* = null;
         var _loc11_:int = 0;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc10_ = var_273[_loc5_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         var_619.push(_loc12_ - _loc2_);
         if(var_619.length == const_720)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_720)
            {
               _loc13_ += var_619[_loc14_];
               _loc14_++;
            }
      ...
      public function dispose() : void
      {
         ...
         if(var_428 != null)
         {
            ...
            {
               cleanSprite(var_428[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_428 = [];
         }
         ...
         while(_loc1_ < var_272.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_918 != null)
                  {
                     var_918.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1377,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_273.length)
         {
            return null;
         }
         return var_273[param1] as SortableSprite;
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1681 || param2 != var_1680)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_428.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:int) : int
      {
         ...
         var _loc6_:IVector3d = var_743.getScreenLocation(param1,_geometry);
         if(_loc6_ == null)
         {
            return 0;
         }
         ...
         while(_loc18_ < _loc7_)
         {
            ...
            if(_loc13_ != null && _loc13_.visible)
            {
               ...
               if(_loc19_ != null)
               {
                  ...
                  if(_loc14_ + _loc19_.width >= 0 && _loc14_ < var_915 && (_loc15_ + _loc19_.height >= 0 && _loc15_ < var_916))
                  {
                     if(_loc11_ < _loc17_)
                     {
                        _loc12_ = var_273[_loc11_];
                     }
                     else
                     {
                        _loc12_ = new SortableSprite();
                        var_273.push(_loc12_);
                     }
